	...
	public partial class SensorDataView : UserControl, ITabView
	{
		...
		private void UserControl_Loaded(object Sender, RoutedEventArgs e)
		{
			if (this.SensorDataListView.View is GridView GridView)
			{
				...
				if (Value is not null && Value is int i && i > 0)
				...
				if (Value is not null && Value is int i2 && i2 > 0)
				...
				if (Value is not null && Value is int i3 && i3 > 0)
				...
				if (Value is not null && Value is int i4 && i4 > 0)
				...
				if (Value is not null && Value is int i5 && i5 > 0)
				...
				if (Value is not null && Value is int i6 && i6 > 0)
