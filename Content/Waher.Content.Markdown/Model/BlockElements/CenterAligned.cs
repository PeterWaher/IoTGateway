...
namespace Waher.Content.Markdown.Model.BlockElements
{
	...
	/// </summary>
	public class CenterAligned : BlockElementChildren
	{
		/// <summary>
		/// Represents a center-aligned set of blocks in a markdown document.
		/// </summary>
		...
		public CenterAligned(MarkdownDocument Document, IEnumerable<MarkdownElement> Children)
		...
		{
			Output.AppendLine("<div class='horizontalAlignCenter'>");
		...
		public override async Task GenerateXAML(XmlWriter Output, TextAlignment TextAlignment)
		{
			...
			foreach (MarkdownElement E in this.Children)
				await E.GenerateXAML(Output, TextAlignment.Center);
		...
		{
			this.Export(Output, "CenterAligned");
		}
		...
		{
			return new CenterAligned(Document, Children);
		}
		...
		{
			Statistics.NrCenterAlignedBlocks++;
		}
	}
}
