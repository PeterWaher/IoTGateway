...
namespace Waher.Content.Markdown.Model.BlockElements
{
	...
	/// </summary>
	public class InsertBlocks : BlockElementChildren
	{
		/// <summary>
		/// Represents inserted blocks in a markdown document.
		/// </summary>
		...
		public InsertBlocks(MarkdownDocument Document, IEnumerable<MarkdownElement> Children)
		...
		{
			Output.AppendLine("<blockquote class=\"inserted\">");
		...
		public override void GenerateXAML(XmlWriter Output, XamlSettings Settings, TextAlignment TextAlignment)
		{
			...
			Output.WriteAttributeString("BorderBrush", Settings.InsertedBlockQuoteBorderColor);
		...
		{
			this.Export(Output, "InsertBlocks");
		}
		...
		{
			return new InsertBlocks(Document, Children);
		}
	}
}
