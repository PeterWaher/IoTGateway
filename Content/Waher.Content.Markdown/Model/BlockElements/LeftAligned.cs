...
namespace Waher.Content.Markdown.Model.BlockElements
{
	...
	/// </summary>
	public class LeftAligned : BlockElementChildren
	{
		/// <summary>
		/// Represents a left-aligned set of blocks in a markdown document.
		/// </summary>
		...
		public LeftAligned(MarkdownDocument Document, IEnumerable<MarkdownElement> Children)
		...
		{
			Output.AppendLine("<div class='horizontalAlignLeft'>");
		...
		{
			Output.AppendLine("\\begin{flushleft}");

			foreach (MarkdownElement E in this.Children)
				await E.GenerateLaTeX(Output);

			Output.AppendLine("\\end{flushleft}");
			Output.AppendLine();
		}
		...
		{
			this.Export(Output, "LeftAligned");
		}
		...
		{
			return new LeftAligned(Document, Children);
		}
		...
		{
			Statistics.NrLeftAlignedBlocks++;
		}
	}
}
