...
namespace Waher.Content.Markdown.Model.SpanElements
{
	...
	public class HtmlEntity : MarkdownElement
	{
		...
		{
			char ch = EntityToCharacter(this.entity);
			if (ch == 0)
		...
		public static char EntityToCharacter(string Entity)
		{
			...
			switch (Entity)
			{
				...
				case "DownBreve;  	": return (char)785;
				case "UnderBar": return (char)818;
				case "Alpha": return 'Α';
				case "Beta": return 'Β';
				case "Gamma": return 'Γ';
				case "Delta": return 'Δ';
				...
				case "emsp13": return (char)8196;
				case "emsp14": return (char)8197;
				case "numsp": return (char)8199;
				case "puncsp": return (char)8200;
				case "thinsp":
				case "ThinSpace": return (char)8201;
				case "hairsp":
				case "VeryThinSpace": return (char)8202;
				case "ZeroWidthSpace":
				case "NegativeVeryThinSpace":
				case "NegativeThinSpace":
				case "NegativeMediumSpace":
				case "NegativeThickSpace": return (char)8203;
				...
				case "bsemi": return '⁏';
				case "qprime": return '⁗';
				case "MediumSpace; ": return (char)8287;
				case "NoBreak": return (char)8288;
				case "ApplyFunction":
				case "af": return (char)8289;
				case "InvisibleTimes":
				case "it": return (char)8290;
				case "InvisibleComma":
				case "ic": return (char)8291;
				case "euro": return '€';
				case "tdot":
				case "TripleDot": return (char)8411;
				case "DotDot": return (char)8412;
				case "Copf":
