...
namespace Waher.Content.Semantic
{
	...
	public class SparqlResultSetJsonCodec : IContentDecoder, IContentEncoder
	{
		...
		private static Dictionary<string, object> Encode(SparqlResultSet Result)
		{
		...
		private static Dictionary<string, object> Encode(ObjectMatrix Result)
		{
			Dictionary<string, object> Head = new Dictionary<string, object>();
			Dictionary<string, object> ResultObj = new Dictionary<string, object>()
			{
		...
		private static Dictionary<string, object> Encode(bool Result)
		{
			Dictionary<string, object> Head = new Dictionary<string, object>();
			Dictionary<string, object> ResultObj = new Dictionary<string, object>()
			{
