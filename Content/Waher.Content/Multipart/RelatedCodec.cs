...
namespace Waher.Content.Multipart
{
	...
	public class RelatedCodec : IContentDecoder, IContentEncoder
	{
		...
		/// </summary>
		public string[] FileExtensions => new string[] { "related" };
		...
		{
			if (string.Compare(FileExtension, "related", true) == 0)
			{
		...
		public bool TryGetFileExtension(string ContentType, out string FileExtension)
		{
			...
			{
				case RelatedCodec.ContentType:
					FileExtension = "related";
					return true;
			...
			ICodecProgress Progress, params string[] AcceptedContentTypes)
		{
				...
				InternetContent.IsAccepted(contentTypes, AcceptedContentTypes))
			{
				...
				return new ContentResponse(ContentType, Object, await FormDataDecoder.Encode(Related.Content, Boundary, Progress));
			}
			else
