...
namespace Waher.Events.Pipe.Test
{
	[TestClass]
	public class PipeTests
	{
		private static PipeEventSink? eventSink;
		private static PipeEventRecipient? eventListener;
		...
		{
			Types.Initialize(
				typeof(PipeTests).Assembly,
				typeof(Log).Assembly,
				typeof(PipeEventSink).Assembly);
		...
		public static void ClassInitialize(TestContext _)
		{
			...
			eventListener = new PipeEventRecipient("UnitTest", false);
			...
			eventSink = new PipeEventSink("Event Sink", "UnitTest");
