	...
	public class Event
	{
...
#if WINDOWS_UWP
			string s;
			this.stackTrace = this.GetStackTrace(3, out s);
#else
			this.stackTrace = new StackTrace(2).ToString();
#endif
		}
		...
		private string GetStackTrace(int Skip, out string Module)
		{
			...
			catch (Exception ex)
			{
				...
				{
					if (Skip == 0)
						Module = Frame.GetMethod().Module.Name;
					else if (Skip-- > 0)
						continue;
		...
		/// <param name="Facility">Facility can be either a facility in the network sense or in the system sense.</param>
		/// <param name="Tags">Variable set of tags providing event-specific information.</param>
		public Event(EventType Type, string Message, string Object, string Actor, string EventId, EventLevel Level, string Facility,
			params KeyValuePair<string, object>[] Tags)
		{
			this.type = Type;
			this.message = Message;
...
#if WINDOWS_UWP
			this.stackTrace = this.GetStackTrace(3, out this.module);
#else
		...
		/// <param name="Level">Event Level.</param>
		/// <param name="Tags">Variable set of tags providing event-specific information.</param>
		public Event(EventType Type, string Message, string Object, string Actor, string EventId, EventLevel Level, params KeyValuePair<string, object>[] Tags)
		{
			this.type = Type;
			this.message = Message;
			this.obj = Object;
		...
		/// <param name="EventId">Computer-readable Event ID identifying type of even.</param>
		/// <param name="Tags">Variable set of tags providing event-specific information.</param>
		public Event(EventType Type, string Message, string Object, string Actor, string EventId, params KeyValuePair<string, object>[] Tags)
		{
			this.type = Type;
			this.message = Message;
			this.obj = Object;
		...
		/// <param name="Actor">Actor responsible for the action causing the event.</param>
		/// <param name="Tags">Variable set of tags providing event-specific information.</param>
		public Event(EventType Type, string Message, string Object, string Actor, params KeyValuePair<string, object>[] Tags)
		{
			this.type = Type;
			this.message = Message;
			this.obj = Object;
		...
		/// <param name="Object">Object related to the event.</param>
		/// <param name="Tags">Variable set of tags providing event-specific information.</param>
		public Event(EventType Type, string Message, string Object, params KeyValuePair<string, object>[] Tags)
		{
			this.type = Type;
			this.message = Message;
			this.obj = Object;
		...
		/// <param name="Message">Free-text event message.</param>
		/// <param name="Tags">Variable set of tags providing event-specific information.</param>
		public Event(EventType Type, string Message, params KeyValuePair<string, object>[] Tags)
		{
			this.type = Type;
			this.message = Message;
		...
		/// <param name="Level">Event Level.</param>
		/// <param name="Tags">Variable set of tags providing event-specific information.</param>
		public Event(EventType Type, Exception Exception, string Object, string Actor, string EventId, EventLevel Level,
			params KeyValuePair<string, object>[] Tags)
		{
			this.type = Type;
			this.message = Exception.Message;
		...
		/// <param name="EventId">Computer-readable Event ID identifying type of even.</param>
		/// <param name="Tags">Variable set of tags providing event-specific information.</param>
		public Event(EventType Type, Exception Exception, string Object, string Actor, string EventId, params KeyValuePair<string, object>[] Tags)
		{
			this.type = Type;
			this.message = Exception.Message;
			this.obj = Object;
		...
		/// <param name="Actor">Actor responsible for the action causing the event.</param>
		/// <param name="Tags">Variable set of tags providing event-specific information.</param>
		public Event(EventType Type, Exception Exception, string Object, string Actor, params KeyValuePair<string, object>[] Tags)
		{
			this.type = Type;
			this.message = Exception.Message;
			this.obj = Object;
		...
		/// <param name="Object">Object related to the event.</param>
		/// <param name="Tags">Variable set of tags providing event-specific information.</param>
		public Event(EventType Type, Exception Exception, string Object, params KeyValuePair<string, object>[] Tags)
		{
			this.type = Type;
			this.message = Exception.Message;
			this.obj = Object;
		...
		/// <param name="Exception">Exception object.</param>
		/// <param name="Tags">Variable set of tags providing event-specific information.</param>
		public Event(EventType Type, Exception Exception, params KeyValuePair<string, object>[] Tags)
		{
			this.type = Type;
			this.message = Exception.Message;
			this.obj = string.Empty;
