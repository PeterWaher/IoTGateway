...
namespace Waher.Groups.Metering.NodeTypes
{
	...
	/// </summary>
	public class MeteringGroupReference : GroupNode, IGroup
	{
		/// <summary>
		/// A reference to a metering group.
		/// </summary>
		...
		{
			return Language.GetStringAsync(typeof(MeteringGroupReference), 10, "Metering Group Reference");
		}
