...
namespace Waher.Groups.Commands
{
	/// <summary>
	...
	public class ClearMessages : ICommand
	{
		...
		{
			return Language.GetStringAsync(typeof(ClearMessages), 3, "Are you sure you want to erase all messages for the selected group(s)?");
		}
