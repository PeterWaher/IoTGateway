...
namespace Waher.Layout.Layout2D.Model.Attributes
{
	...
	public class FloatAttribute : Attribute<float>
	{
		...
		public FloatAttribute(string AttributeName, float Value, Layout2DDocument Document)
		...
		/// <param name="AttributeName">Attribute name.</param>
		/// <param name="Document">Document hosting the attribute.</param>
		public FloatAttribute(XmlElement E, string AttributeName, Layout2DDocument Document)
		...
		/// <param name="Document">Document hosting the attribute.</param>
		public FloatAttribute(string AttributeName, Expression Expression, Layout2DDocument Document)
		...
		public FloatAttribute CopyIfNotPreset(Layout2DDocument ForDocument)
		{
			if (this.HasPresetValue)
				return this;
			else
				return new FloatAttribute(this.Name, this.Expression, ForDocument);
		}
