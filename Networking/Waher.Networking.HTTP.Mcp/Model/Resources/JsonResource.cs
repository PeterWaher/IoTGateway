...
namespace Waher.Networking.HTTP.Mcp.Model.Resources
{
	...
	public class JsonResource : Resource
	{
		...
		public JsonResource(string Name, string Title, string Description, Uri Uri,
			...
			Dictionary<string, object>? MetaData)
		{
			...
			string s = JSON.Encode(Result, false);

			return new IResourceContent[]
			{
				new TextContent(this.Uri,s,JsonCodec.DefaultContentType,MetaData)
			};
		}
	}
}
