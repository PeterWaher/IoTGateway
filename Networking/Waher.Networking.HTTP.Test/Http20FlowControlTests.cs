...
namespace Waher.Networking.HTTP.Test
{
	...
	public class Http20FlowControlTests
	{
		...
		public async Task Test_01_BasicFlowControl()
		{
			...
			Assert.IsTrue(FlowControl.TryGetPriorityNode(1, out PriorityNode Node));
		...
		public async Task Test_02_SiblingStreams()
		{
			...
			Assert.IsTrue(FlowControl.TryGetPriorityNode(1, out PriorityNode Node1));
			Assert.AreEqual(0, Node1.AvailableResources);
			Assert.IsTrue(FlowControl.TryGetPriorityNode(3, out PriorityNode Node2));
		...
		public async Task Test_03_ChildDependencies()
		{
			...
			Assert.IsTrue(FlowControl.TryGetPriorityNode(5, out PriorityNode Node3));
			Assert.AreEqual(0, Node3.AvailableResources);
			Assert.IsTrue(FlowControl.TryGetPriorityNode(7, out PriorityNode Node4));
		...
		/* 
		 * Releasing resources of streams that have been removed
		 * UpdatePriority
		 * UpdateSettings
		 * Exclusive reorder
