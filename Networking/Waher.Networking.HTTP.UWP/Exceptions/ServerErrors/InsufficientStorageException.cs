...
namespace Waher.Networking.HTTP
{
	...
	public class InsufficientStorageException : HttpException
	{
		...
		public InsufficientStorageException(params KeyValuePair<string, string>[] HeaderFields)
		...
		/// <param name="HeaderFields">HTTP Header fields to include in the response.</param>
		public InsufficientStorageException(object ContentObject, params KeyValuePair<string, string>[] HeaderFields)
		...
		/// <param name="HeaderFields">HTTP Header fields to include in the response.</param>
		public InsufficientStorageException(byte[] Content, string ContentType, params KeyValuePair<string, string>[] HeaderFields)
