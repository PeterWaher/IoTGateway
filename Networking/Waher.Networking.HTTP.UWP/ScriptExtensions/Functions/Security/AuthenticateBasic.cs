...
namespace Waher.Networking.HTTP.ScriptExtensions.Functions.Security
{
	...
	/// </summary>
	public class AuthenticateBasic : FunctionMultiVariate
	{
		/// <summary>
		/// Authenticates an HTTP request using BASIC authentication.
		/// </summary>
		...
		public AuthenticateBasic(ScriptNode Request, ScriptNode Realm, ScriptNode Users, int Start, int Length, Expression Expression)
		...
		/// <param name="Length">Length of expression covered by node.</param>
		/// <param name="Expression">Expression.</param>
		public AuthenticateBasic(ScriptNode Request, ScriptNode Realm, ScriptNode Users, ScriptNode EncryptionStrength, int Start, int Length, Expression Expression)
		...
		/// </summary>
		public override string FunctionName => nameof(AuthenticateBasic);
		...
		public override async Task<IElement> EvaluateAsync(IElement[] Arguments, Variables Variables)
		{
			...
			BasicAuthentication Mechanism = this.last;
		...
		private BasicAuthentication last = null;
	}
}
