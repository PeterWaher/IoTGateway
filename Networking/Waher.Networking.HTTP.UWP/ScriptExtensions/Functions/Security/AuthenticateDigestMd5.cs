...
{
	/// <summary>
	/// Authenticates an HTTP request using DIGEST MD5 authentication.
	/// </summary>
	public class AuthenticateDigestMd5 : FunctionMultiVariate
	{
		/// <summary>
		/// Authenticates an HTTP request using DIGEST MD5 authentication.
		/// </summary>
		...
		public AuthenticateDigestMd5(ScriptNode Request, ScriptNode Realm, ScriptNode Users, int Start, int Length, Expression Expression)
		...
		/// <param name="Length">Length of expression covered by node.</param>
		/// <param name="Expression">Expression.</param>
		public AuthenticateDigestMd5(ScriptNode Request, ScriptNode Realm, ScriptNode Users, ScriptNode EncryptionStrength, int Start, int Length, Expression Expression)
		...
		/// </summary>
		public override string FunctionName => nameof(AuthenticateDigestMd5);
		...
		public override async Task<IElement> EvaluateAsync(IElement[] Arguments, Variables Variables)
		{
			...
			if (Mechanism is null || this.last.Realm != Realm || this.last.Users != Users)
				Mechanism = this.last = new DigestAuthentication(false, 0, DigestAlgorithm.MD5, Realm, Users);
