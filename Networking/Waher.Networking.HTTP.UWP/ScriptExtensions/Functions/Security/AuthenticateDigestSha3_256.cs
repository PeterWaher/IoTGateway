...
{
	/// <summary>
	/// Authenticates an HTTP request using DIGEST SHA3-256 authentication.
	/// </summary>
	public class AuthenticateDigestSha3_256 : FunctionMultiVariate
	{
		/// <summary>
		/// Authenticates an HTTP request using DIGEST SHA3-256 authentication.
		/// </summary>
		...
		public AuthenticateDigestSha3_256(ScriptNode Request, ScriptNode Realm, ScriptNode Users, int Start, int Length, Expression Expression)
		...
		/// <param name="Length">Length of expression covered by node.</param>
		/// <param name="Expression">Expression.</param>
		public AuthenticateDigestSha3_256(ScriptNode Request, ScriptNode Realm, ScriptNode Users, ScriptNode EncryptionStrength, int Start, int Length, Expression Expression)
		...
		/// </summary>
		public override string FunctionName => nameof(AuthenticateDigestSha3_256);
