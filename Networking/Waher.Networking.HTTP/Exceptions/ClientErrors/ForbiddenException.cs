...
namespace Waher.Networking.HTTP
{
	...
	public class ForbiddenException : HttpException
	{
		...
		/// <param name="HeaderFields">HTTP Header fields to include in the response.</param>
		public ForbiddenException(HttpRequest Request, params KeyValuePair<string, string>[] HeaderFields)
			: base(Code, StatusMessage, Request, HeaderFields)
		{
		}
		...
		/// <param name="ContentObject">Any content object to return. The object will be encoded before being sent.</param>
		/// <param name="HeaderFields">HTTP Header fields to include in the response.</param>
		public ForbiddenException(HttpRequest Request, object ContentObject, params KeyValuePair<string, string>[] HeaderFields)
			: base(Code, StatusMessage, Request, ContentObject, HeaderFields)
		{
		}
		...
		/// <param name="ContentType">The content type of <paramref name="Content"/>, if provided.</param>
		/// <param name="HeaderFields">HTTP Header fields to include in the response.</param>
		public ForbiddenException(HttpRequest Request, byte[] Content, string ContentType, params KeyValuePair<string, string>[] HeaderFields)
			: base(Code, StatusMessage, Request, Content, ContentType, HeaderFields)
		{
		}
		...
		public static ForbiddenException AccessDenied(string ObjectId, string ActorId)
		{
			return AccessDenied(ObjectId, ActorId, null);
		}
		...
		{
			if (string.IsNullOrEmpty(MissingPrivilege))
		...
		/// <param name="ActorId">Actor ID</param>
		/// <returns>Exception object.</returns>
		public static ForbiddenException AccessDenied(HttpRequest Request, string ObjectId, string ActorId)
		{
			return AccessDenied(Request, ObjectId, ActorId, null);
		}
		...
		/// <param name="MissingPrivilege">Missing Privilege.</param>
		/// <returns>Exception object.</returns>
		public static ForbiddenException AccessDenied(HttpRequest Request, string ObjectId, string ActorId, string MissingPrivilege)
		{
			return AccessDenied(Request, "Access denied. Missing privileges.", ObjectId, ActorId, MissingPrivilege);
		}
		...
		/// <param name="MissingPrivilege">Missing Privilege.</param>
		/// <returns>Exception object.</returns>
		public static ForbiddenException AccessDenied(HttpRequest Request, string Message, string ObjectId, string ActorId, string MissingPrivilege)
		{
			if (string.IsNullOrEmpty(MissingPrivilege))
				Log.Notice(Message, ObjectId, ActorId, "AccessDenied");
			else
			...
			return new ForbiddenException(Request, "Access denied. Missing privileges.");
		}
	}
}
