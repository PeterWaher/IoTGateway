namespace Waher.Networking.XMPP.Contracts
{
	...
	public interface IParameterEncryptionAlgorithm
	{
		...
		byte[] Encrypt(string ParameterName, string ParameterType, uint ParameterIndex, string CreatorJid, string ContractNonce, string ClearText);
		...
		string Decrypt(string ParameterName, string ParameterType, uint ParameterIndex, string CreatorJid, string ContractNonce, byte[] CipherText);
	}
}
