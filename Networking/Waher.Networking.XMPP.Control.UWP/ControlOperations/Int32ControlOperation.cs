...
namespace Waher.Networking.XMPP.Control.ControlOperations
{
	...
	{
		private Int32ControlParameter parameter;
		private int value;
		...
		public Int32ControlOperation(ThingReference Node, Int32ControlParameter Parameter, int Value, IqEventArgs request)
		...
		/// Control parameter
		/// </summary>
		public Int32ControlParameter Parameter
		{
