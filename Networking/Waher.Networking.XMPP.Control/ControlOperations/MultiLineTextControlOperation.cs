...
namespace Waher.Networking.XMPP.Control.ControlOperations
{
	...
	{
		private readonly MultiLineTextControlParameter parameter;
		...
		public MultiLineTextControlOperation(IThingReference Node, MultiLineTextControlParameter Parameter, string Value, IqEventArgs request)
		...
		/// Control parameter
		/// </summary>
		public MultiLineTextControlParameter Parameter => this.parameter;
