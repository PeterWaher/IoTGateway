...
namespace Waher.Networking.XMPP.P2P.E2E
{
	...
	public class NistP224Endpoint : NistEndpoint
    {
		...
		{
			return new NistP224Endpoint(this.DefaultSymmetricCipher);
		}
        ...
        {
            return new NistP224Endpoint(new NistP224(Secret), this.DefaultSymmetricCipher);
        }
        ...
        {
            return new NistP224Endpoint(PublicKey, this.DefaultSymmetricCipher);
        }
    }
}
