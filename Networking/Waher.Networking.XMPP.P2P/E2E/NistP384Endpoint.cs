...
namespace Waher.Networking.XMPP.P2P.E2E
{
	...
	public class NistP384Endpoint : NistEndpoint
    {
		...
		{
			return new NistP384Endpoint(this.DefaultSymmetricCipher);
		}
        ...
        {
            return new NistP384Endpoint(new NistP384(Secret), this.DefaultSymmetricCipher);
        }
        ...
        {
            return new NistP384Endpoint(PublicKey, this.DefaultSymmetricCipher);
        }
    }
}
