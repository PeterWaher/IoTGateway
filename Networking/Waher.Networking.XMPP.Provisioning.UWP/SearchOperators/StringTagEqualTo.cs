namespace Waher.Networking.XMPP.Provisioning.SearchOperators
{
	...
	/// </summary>
	public class StringTagEqualTo : SearchOperatorString
	{
		/// <summary>
		/// Filters things with a named string-valued tag equal to a given value.
		/// </summary>
		...
		public StringTagEqualTo(string Name, string Value)
		...
		/// <param name="Value">Tag value.</param>
		public StringTagEqualTo(string Name, string NameWildcard, string Value)
			: base(Name, NameWildcard, Value)
		{
		}

		internal override string TagName => "strEq";
	}
}
