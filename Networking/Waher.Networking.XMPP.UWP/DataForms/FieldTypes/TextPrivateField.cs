...
namespace Waher.Networking.XMPP.DataForms.FieldTypes
{
	...
	public class TextPrivateField : Field
	{
		...
		public TextPrivateField(DataForm Form, string Var, string Label, bool Required, string[] ValueStrings, KeyValuePair<string, string>[] Options, string Description,
		...
		/// <param name="Label">Label</param>
		/// <param name="Value">Value for the field.</param>
		public TextPrivateField(string Var, string Label, string Value)
		...
		/// <inheritdoc/>
		public override string TypeName => "text-private";
