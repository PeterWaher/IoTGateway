...
namespace Waher.Networking.XMPP.DataForms.FieldTypes
{
	...
	public class ListSingleField : Field
	{
		...
		public ListSingleField(DataForm Form, string Var, string Label, bool Required, string[] ValueStrings, KeyValuePair<string, string>[] Options, string Description,
		...
		public ListSingleField(string Var, string Value)
		...
		/// <param name="Label">Label</param>
		/// <param name="Value">Value for the field (string representations).</param>
		public ListSingleField(string Var, string Label, string Value)
		...
		/// <inheritdoc/>
		public override string TypeName => "list-single";
