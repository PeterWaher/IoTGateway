...
namespace Waher.Networking.XMPP
{
    ...
    public class XmppClient : Sniffable, IDisposable
    {
        ...
        public XmppClient(string Host, int Port, string UserName, string Password, string Language
            ...
            : this(Host, Port, UserName, Password, Language, (X509Certificate)null, Sniffers)
#endif
        {
        }
        ...
        public XmppClient(string Host, int Port, string UserName, string Password, string Language,
#if WINDOWS_UWP
			Assembly AppAssembly, Certificate ClientCertificate, params ISniffer[] Sniffers)
#else
...
#else
            , params ISniffer[] Sniffers)
            : this(Host, Port, UserName, PasswordHash, PasswordHashMethod, Language, null, Sniffers)
#endif
        {
        }
