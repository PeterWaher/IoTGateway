...
namespace Waher.Output.Commands
{
	...
	public class ClearMessages : ICommand
	{
		...
		public ClearMessages(OutputNode Node)
		{
			this.node = Node;
		}
		...
		{
			return Language.GetStringAsync(typeof(ClearMessages), 3, "Are you sure you want to erase all messages for the selected output(s)?");
		}
