...
#endif
{
	...
	public abstract class DBFilesBTreeTests
	{
		...
		public async Task DBFiles_BTree_Test_18_TypedEnumeration()
		{
			...
			using (ObjectBTreeFileEnumerator<Simple> e = this.file.GetTypedEnumeratorAsync<Simple>(false))
			{
				while (e.MoveNext())
				{
					Obj = e.Current;
		...
		public async Task DBFiles_BTree_Test_19_LockedEnumeration()
		{
			...
			using (ObjectBTreeFileEnumerator<Simple> e = this.file.GetTypedEnumeratorAsync<Simple>(true))
			{
				while (e.MoveNext())
				{
					Obj = e.Current;
