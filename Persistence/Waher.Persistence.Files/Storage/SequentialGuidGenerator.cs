...
namespace Waher.Persistence.Files.Storage
{
	...
	public class SequentialGuidGenerator : IDisposable
	{
		...
		public SequentialGuidGenerator()
		{
			...
			this.processId = BitConverter.GetBytes((ushort)(Process.GetCurrentProcess().Id));
		...
		/// 
		/// Bytes 0-3:		Lowest 32 bits of current time stamp, in ticks.
		...
		public Guid CreateGuid()
		{
			...
			lock (this.gen)
			{
				...
				Buf = BitConverter.GetBytes((uint)Ticks);
