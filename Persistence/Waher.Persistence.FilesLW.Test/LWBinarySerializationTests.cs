...
#endif
{
	...
	public class DBBinarySerializationTests
	{
		...
		public void BinSerialization_Test_01_Serialization()
		{
			...
			Serializer.Write(new DateTimeOffset(new DateTime(2016, 10, 06, 20, 32, 0), new TimeSpan(12, 34, 0)));
			...
			Serializer.WriteVariableLengthInt16(-100);
			Serializer.WriteVariableLengthInt16(-10000);
			Serializer.WriteVariableLengthInt32(-100);
			Serializer.WriteVariableLengthInt32(-10000);
			Serializer.WriteVariableLengthInt32(-1000000);
			Serializer.WriteVariableLengthInt32(-100000000);
			Serializer.WriteVariableLengthInt64(-100);
			Serializer.WriteVariableLengthInt64(-10000);
			Serializer.WriteVariableLengthInt64(-1000000);
			Serializer.WriteVariableLengthInt64(-100000000);
			Serializer.WriteVariableLengthInt64(-10000000000);
			Serializer.WriteVariableLengthInt64(-1000000000000);
			Serializer.WriteVariableLengthInt64(-100000000000000);
			Serializer.WriteVariableLengthInt64(-10000000000000000);
			Serializer.WriteVariableLengthInt16(0);
			Serializer.WriteVariableLengthInt16(100);
			Serializer.WriteVariableLengthInt16(10000);
			Serializer.WriteVariableLengthInt32(0);
			Serializer.WriteVariableLengthInt32(100);
			Serializer.WriteVariableLengthInt32(10000);
			Serializer.WriteVariableLengthInt32(1000000);
			Serializer.WriteVariableLengthInt32(100000000);
			Serializer.WriteVariableLengthInt64(0);
			Serializer.WriteVariableLengthInt64(100);
			Serializer.WriteVariableLengthInt64(10000);
			Serializer.WriteVariableLengthInt64(1000000);
			Serializer.WriteVariableLengthInt64(100000000);
			...
			Serializer.WriteVariableLengthInt64(100000000000000);
			Serializer.WriteVariableLengthInt64(10000000000000000);
			Serializer.WriteVariableLengthUInt16(0);
			Serializer.WriteVariableLengthUInt16(100);
			Serializer.WriteVariableLengthUInt16(10000);
			Serializer.WriteVariableLengthUInt32(0);
			Serializer.WriteVariableLengthUInt32(100);
			Serializer.WriteVariableLengthUInt32(10000);
			Serializer.WriteVariableLengthUInt32(1000000);
			Serializer.WriteVariableLengthUInt32(100000000);
			...
			AssertEx.Same(new DateTimeOffset(new DateTime(2016, 10, 06, 20, 32, 0), new TimeSpan(12, 34, 0)), Deserializer.ReadDateTimeOffset());
			...
			AssertEx.Same(-100, Deserializer.ReadVariableLengthInt16());
			AssertEx.Same(-10000, Deserializer.ReadVariableLengthInt16());
			AssertEx.Same(-100, Deserializer.ReadVariableLengthInt32());
			AssertEx.Same(-10000, Deserializer.ReadVariableLengthInt32());
			AssertEx.Same(-1000000, Deserializer.ReadVariableLengthInt32());
			AssertEx.Same(-100000000, Deserializer.ReadVariableLengthInt32());
			AssertEx.Same(-100, Deserializer.ReadVariableLengthInt64());
			AssertEx.Same(-10000, Deserializer.ReadVariableLengthInt64());
			AssertEx.Same(-1000000, Deserializer.ReadVariableLengthInt64());
			AssertEx.Same(-100000000, Deserializer.ReadVariableLengthInt64());
			AssertEx.Same(-10000000000, Deserializer.ReadVariableLengthInt64());
			AssertEx.Same(-1000000000000, Deserializer.ReadVariableLengthInt64());
			AssertEx.Same(-100000000000000, Deserializer.ReadVariableLengthInt64());
			AssertEx.Same(-10000000000000000, Deserializer.ReadVariableLengthInt64());
			AssertEx.Same(0, Deserializer.ReadVariableLengthInt16());
			AssertEx.Same(100, Deserializer.ReadVariableLengthInt16());
			AssertEx.Same(10000, Deserializer.ReadVariableLengthInt16());
			AssertEx.Same(0, Deserializer.ReadVariableLengthInt32());
			AssertEx.Same(100, Deserializer.ReadVariableLengthInt32());
			AssertEx.Same(10000, Deserializer.ReadVariableLengthInt32());
			AssertEx.Same(1000000, Deserializer.ReadVariableLengthInt32());
			AssertEx.Same(100000000, Deserializer.ReadVariableLengthInt32());
			AssertEx.Same(0, Deserializer.ReadVariableLengthInt64());
			AssertEx.Same(100, Deserializer.ReadVariableLengthInt64());
			AssertEx.Same(10000, Deserializer.ReadVariableLengthInt64());
			AssertEx.Same(1000000, Deserializer.ReadVariableLengthInt64());
			AssertEx.Same(100000000, Deserializer.ReadVariableLengthInt64());
			...
			AssertEx.Same(100000000000000, Deserializer.ReadVariableLengthInt64());
			AssertEx.Same(10000000000000000, Deserializer.ReadVariableLengthInt64());
			AssertEx.Same(0, Deserializer.ReadVariableLengthUInt16());
			AssertEx.Same(100, Deserializer.ReadVariableLengthUInt16());
			AssertEx.Same(10000, Deserializer.ReadVariableLengthUInt16());
			AssertEx.Same(0, Deserializer.ReadVariableLengthUInt32());
			AssertEx.Same(100, Deserializer.ReadVariableLengthUInt32());
			AssertEx.Same(10000, Deserializer.ReadVariableLengthUInt32());
			AssertEx.Same(1000000, Deserializer.ReadVariableLengthUInt32());
			AssertEx.Same(100000000, Deserializer.ReadVariableLengthUInt32());
