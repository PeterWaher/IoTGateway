	...
	public class NullableUInt64Serializer : NullableValueTypeSerializer
	{
		...
		public override object Deserialize(IBsonReader Reader, BsonType? DataType, bool Embedded)
		{
			...
			switch (DataType.Value)
			{
				...
				case BsonType.String: return (ulong?)ulong.Parse(Reader.ReadString());
				case BsonType.MinKey: Reader.ReadMinKey(); return (ulong?)ulong.MinValue;
				case BsonType.MaxKey: Reader.ReadMaxKey(); return (ulong?)ulong.MaxValue;
				case BsonType.Null: Reader.ReadNull(); return null;
				default: throw new Exception("Expected a nullable ulong value.");
			}
		}
