	...
	public class NullableBooleanSerializer : NullableValueTypeSerializer
	{
		...
		public override Task<object> Deserialize(IDeserializer Reader, uint? DataType, bool Embedded)
		{
			...
			switch (DataType.Value)
			{
				...
				case ObjectSerializer.TYPE_VARINT16: return Task.FromResult<object>((bool?)(Reader.ReadVariableLengthInt16() != 0));
				case ObjectSerializer.TYPE_VARINT32: return Task.FromResult<object>((bool?)(Reader.ReadVariableLengthInt32() != 0));
				case ObjectSerializer.TYPE_VARINT64: return Task.FromResult<object>((bool?)(Reader.ReadVariableLengthInt64() != 0));
				case ObjectSerializer.TYPE_VARUINT16: return Task.FromResult<object>((bool?)(Reader.ReadVariableLengthUInt16() != 0));
				case ObjectSerializer.TYPE_VARUINT32: return Task.FromResult<object>((bool?)(Reader.ReadVariableLengthUInt32() != 0));
				case ObjectSerializer.TYPE_VARUINT64: return Task.FromResult<object>((bool?)(Reader.ReadVariableLengthUInt64() != 0));
