	...
	public class NullableDecimalSerializer : NullableValueTypeSerializer
	{
		...
		public override Task<object> Deserialize(IDeserializer Reader, uint? DataType, bool Embedded)
		{
			...
			switch (DataType.Value)
			{
				...
				case ObjectSerializer.TYPE_VARINT16: return Task.FromResult<object>((decimal?)Reader.ReadVariableLengthInt16());
				case ObjectSerializer.TYPE_VARINT32: return Task.FromResult<object>((decimal?)Reader.ReadVariableLengthInt32());
				case ObjectSerializer.TYPE_VARINT64: return Task.FromResult<object>((decimal?)Reader.ReadVariableLengthInt64());
				case ObjectSerializer.TYPE_VARUINT16: return Task.FromResult<object>((decimal?)Reader.ReadVariableLengthUInt16());
				case ObjectSerializer.TYPE_VARUINT32: return Task.FromResult<object>((decimal?)Reader.ReadVariableLengthUInt32());
				case ObjectSerializer.TYPE_VARUINT64: return Task.FromResult<object>((decimal?)Reader.ReadVariableLengthUInt64());
				case ObjectSerializer.TYPE_DECIMAL: return Task.FromResult<object>((decimal?)Reader.ReadDecimal());
				...
				case ObjectSerializer.TYPE_CI_STRING: return Task.FromResult<object>((decimal?)decimal.Parse(Reader.ReadString()));
