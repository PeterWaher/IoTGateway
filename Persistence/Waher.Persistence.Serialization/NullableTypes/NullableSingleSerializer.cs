	...
	public class NullableSingleSerializer : NullableValueTypeSerializer
	{
		...
		public override Task<object> Deserialize(IDeserializer Reader, uint? DataType, bool Embedded)
		{
			...
			switch (DataType.Value)
			{
				...
				case ObjectSerializer.TYPE_VARINT16: return Task.FromResult<object>((float?)Reader.ReadVariableLengthInt16());
				case ObjectSerializer.TYPE_VARINT32: return Task.FromResult<object>((float?)Reader.ReadVariableLengthInt32());
				case ObjectSerializer.TYPE_VARINT64: return Task.FromResult<object>((float?)Reader.ReadVariableLengthInt64());
				case ObjectSerializer.TYPE_VARUINT16: return Task.FromResult<object>((float?)Reader.ReadVariableLengthUInt16());
				case ObjectSerializer.TYPE_VARUINT32: return Task.FromResult<object>((float?)Reader.ReadVariableLengthUInt32());
				case ObjectSerializer.TYPE_VARUINT64: return Task.FromResult<object>((float?)Reader.ReadVariableLengthUInt64());
				...
				case ObjectSerializer.TYPE_SINGLE: return Task.FromResult<object>((float?)Reader.ReadSingle());
				case ObjectSerializer.TYPE_STRING:
				case ObjectSerializer.TYPE_CI_STRING: return Task.FromResult<object>((float?)float.Parse(Reader.ReadString()));
