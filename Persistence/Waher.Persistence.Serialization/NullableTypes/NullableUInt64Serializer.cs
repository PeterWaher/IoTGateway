	...
	public class NullableUInt64Serializer : NullableValueTypeSerializer
	{
		...
		public override Task<object> Deserialize(IDeserializer Reader, uint? DataType, bool Embedded)
		{
			...
			switch (DataType.Value)
			{
				...
				case ObjectSerializer.TYPE_VARINT16: return Task.FromResult<object>((ulong?)Reader.ReadVariableLengthInt16());
				case ObjectSerializer.TYPE_VARINT32: return Task.FromResult<object>((ulong?)Reader.ReadVariableLengthInt32());
				case ObjectSerializer.TYPE_VARINT64: return Task.FromResult<object>((ulong?)Reader.ReadVariableLengthInt64());
				case ObjectSerializer.TYPE_VARUINT16: return Task.FromResult<object>((ulong?)Reader.ReadVariableLengthUInt16());
				case ObjectSerializer.TYPE_VARUINT32: return Task.FromResult<object>((ulong?)Reader.ReadVariableLengthUInt32());
				case ObjectSerializer.TYPE_VARUINT64: return Task.FromResult<object>((ulong?)Reader.ReadVariableLengthUInt64());
