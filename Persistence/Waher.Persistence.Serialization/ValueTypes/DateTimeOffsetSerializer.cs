	...
	public class DateTimeOffsetSerializer : ValueTypeSerializer
	{
		...
		public override Task<object> Deserialize(IDeserializer Reader, uint? DataType, bool Embedded)
		{
			...
			switch (DataType.Value)
			{
				...
				case ObjectSerializer.TYPE_DATETIMEOFFSET: return Task.FromResult<object>(Reader.ReadDateTimeOffset());
				case ObjectSerializer.TYPE_STRING:
				case ObjectSerializer.TYPE_CI_STRING: return Task.FromResult<object>(DateTimeOffset.Parse(Reader.ReadString()));
