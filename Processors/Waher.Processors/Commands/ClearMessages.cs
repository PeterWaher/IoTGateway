...
namespace Waher.Processors.Commands
{
	/// <summary>
	...
	{
		private readonly ProcessorNode node;

		/// <summary>
		/// Clears all messages for a processor.
		/// </summary>
		/// <param name="Node">Job node.</param>
		public ClearMessages(ProcessorNode Node)
		{
			this.node = Node;
		}
		...
		/// </summary>
		public string SortCategory => "Processor";
		...
		{
			return Language.GetStringAsync(typeof(ClearMessages), 1, "Erase messages");
		}
		...
		{
			return Language.GetStringAsync(typeof(ClearMessages), 2, "Messages successfully erased.");
		}
		...
		{
			return Language.GetStringAsync(typeof(ClearMessages), 3, "Are you sure you want to erase all messages for the selected processor(s)?");
		}
		...
		{
			return Language.GetStringAsync(typeof(ClearMessages), 4, "Unable to erase messages.");
		}
