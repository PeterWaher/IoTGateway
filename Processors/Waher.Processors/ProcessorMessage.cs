...
namespace Waher.Processors
{
	...
	/// </summary>
	[CollectionName("ProcessorMessages")]
	...
	public class ProcessorMessage
	{
		...
		/// </summary>
		/// <param name="NodeId">Object ID of job node on which message has been logged.</param>
		/// <param name="Timestamp">Message Timestamp.</param>
		/// <param name="Type">Type of message.</param>
		/// <param name="EventId">Optional Event ID.</param>
		/// <param name="Body">Message body.</param>
		public ProcessorMessage(Guid NodeId, DateTime Timestamp, MessageType Type, string EventId, string Body)
		{
			this.nodeId = NodeId;
