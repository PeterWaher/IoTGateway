...
{
    /// <summary>
    /// Represents a 16-bit integer-valued parameter.
    /// </summary>
    public class Int16Parameter : ReportParameterWithOptions
	{
		...
		public Int16Parameter(string Page, string Name, string Label, string Description,
			bool Required, bool RestrictToOptions, ParameterOption[] Options,
			short? DefaultValue, short? Min, short? Max)
        ...
        public override Task PopulateForm(DataForm Parameters, Language Language, object Value)
        {
            ...
            if (this.RestrictToOptions)
            {
                Field = new ListSingleField(Parameters, this.Name, this.Label, this.Required,
                    ...
                    ShortDataType.Instance, Validation, string.Empty, false, false, false);
            }
            else
            {
