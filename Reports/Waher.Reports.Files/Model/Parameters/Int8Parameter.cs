...
{
    /// <summary>
    /// Represents a 8-bit integer-valued parameter.
    /// </summary>
    public class Int8Parameter : ReportParameterWithOptions
	{
		...
		public Int8Parameter(string Page, string Name, string Label, string Description,
			bool Required, bool RestrictToOptions, ParameterOption[] Options,
			sbyte? DefaultValue, sbyte? Min, sbyte? Max)
