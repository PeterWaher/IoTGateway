...
namespace Waher.Script.Content.Functions.InputOutput
{
	...
	public class FileCreationTimeUtc : FunctionOneScalarVariable
	{
		...
		public FileCreationTimeUtc(ScriptNode FileName, int Start, int Length, Expression Expression)
		...
		/// </summary>
		public override string FunctionName => nameof(FileCreationTimeUtc);
		...
		public override IElement EvaluateScalar(string Argument, Variables Variables)
		{
			...
			return new DateTimeValue(File.GetCreationTimeUtc(FileName));
		}
	}
}
