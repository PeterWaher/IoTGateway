...
namespace Waher.Script.Cryptography.Functions.Ecc
{
	...
	/// </summary>
	public class P224 : FunctionMultiVariate
	{
		/// <summary>
		/// Creates an NIST-P224 Elliptic curve.
		/// </summary>
		...
		public P224(int Start, int Length, Expression Expression)
		...
		/// <param name="Length">Length of expression covered by node.</param>
		/// <param name="Expression">Expression containing script.</param>
		public P224(ScriptNode PrivateKey, int Start, int Length, Expression Expression)
		...
		/// </summary>
		public override string FunctionName => nameof(P224);
