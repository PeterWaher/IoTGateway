...
namespace Waher.Script.Cryptography.Functions.Ecc
{
	...
	/// </summary>
	public class P256 : FunctionMultiVariate
	{
		/// <summary>
		/// Creates an NIST-P256 Elliptic curve.
		/// </summary>
		...
		/// <param name="Length">Length of expression covered by node.</param>
		/// <param name="Expression">Expression containing script.</param>
		public P256(ScriptNode PrivateKey, int Start, int Length, Expression Expression)
		...
		/// </summary>
		public override string FunctionName => nameof(P256);
