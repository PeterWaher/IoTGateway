...
namespace Waher.Script.Cryptography.Functions.Ecc
{
	...
	/// </summary>
	public class P521 : FunctionMultiVariate
	{
		/// <summary>
		/// Creates an NIST-P521 Elliptic curve.
		/// </summary>
		...
		public P521(int Start, int Length, Expression Expression)
		...
		/// <param name="Length">Length of expression covered by node.</param>
		/// <param name="Expression">Expression containing script.</param>
		public P521(ScriptNode PrivateKey, int Start, int Length, Expression Expression)
		...
		/// </summary>
		public override string FunctionName => nameof(P521);
