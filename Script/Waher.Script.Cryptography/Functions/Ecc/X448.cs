...
namespace Waher.Script.Cryptography.Functions.Ecc
{
	...
	/// </summary>
	public class X448 : FunctionMultiVariate
	{
		/// <summary>
		/// Creates an Curve448 Elliptic curve.
		/// </summary>
		...
		public X448(int Start, int Length, Expression Expression)
		...
		/// <param name="Length">Length of expression covered by node.</param>
		/// <param name="Expression">Expression containing script.</param>
		public X448(ScriptNode PrivateKey, int Start, int Length, Expression Expression)
		...
		/// </summary>
		public override string FunctionName => nameof(X448);
