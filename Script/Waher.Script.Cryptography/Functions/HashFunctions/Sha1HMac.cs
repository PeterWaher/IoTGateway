...
namespace Waher.Script.Cryptography.Functions.HashFunctions
{
	...
	/// Sha1HMac(Data)
	/// </summary>
	public class Sha1HMac : FunctionTwoVariables
	{
		/// <summary>
		/// Sha1HMac(Data)
		/// </summary>
		...
		public Sha1HMac(ScriptNode Data, ScriptNode Key, int Start, int Length, Expression Expression)
		...
		/// </summary>
		public override string FunctionName => nameof(Sha1HMac);
