...
namespace Waher.Script.Cryptography.Functions.HashFunctions
{
	...
	/// Sha2_256(Data)
	/// </summary>
	public class Sha2_256 : FunctionOneScalarVariable
	{
		/// <summary>
		/// Sha2_256(Data)
		/// </summary>
		...
		public Sha2_256(ScriptNode Data, int Start, int Length, Expression Expression)
		...
		/// </summary>
		public override string FunctionName => nameof(Sha2_256);
