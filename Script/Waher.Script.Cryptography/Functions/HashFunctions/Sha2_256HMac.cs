...
namespace Waher.Script.Cryptography.Functions.HashFunctions
{
	...
	/// Sha2_256HMac(Data)
	/// </summary>
	public class Sha2_256HMac : FunctionTwoVariables
	{
		/// <summary>
		/// Sha2_256HMac(Data)
		/// </summary>
		...
		public Sha2_256HMac(ScriptNode Data, ScriptNode Key, int Start, int Length, Expression Expression)
		...
		/// </summary>
		public override string FunctionName => nameof(Sha2_256HMac);
		...
		public override IElement Evaluate(IElement Argument1, IElement Argument2, Variables Variables)
		{
			...
			return new ObjectValue(Hashes.ComputeHMACSHA256Hash(Key, Data));
		}
