...
namespace Waher.Script.Cryptography.Functions.HashFunctions
{
	...
	/// Sha2_512HMac(Data)
	/// </summary>
	public class Sha2_512HMac : FunctionTwoVariables
	{
		/// <summary>
		/// Sha2_512HMac(Data)
		/// </summary>
		...
		public Sha2_512HMac(ScriptNode Data, ScriptNode Key, int Start, int Length, Expression Expression)
		...
		/// </summary>
		public override string FunctionName => nameof(Sha2_512HMac);
		...
		public override IElement Evaluate(IElement Argument1, IElement Argument2, Variables Variables)
		{
			...
			return new ObjectValue(Hashes.ComputeHMACSHA512Hash(Key, Data));
		}
