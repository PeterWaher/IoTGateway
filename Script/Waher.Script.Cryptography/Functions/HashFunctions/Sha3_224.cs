...
namespace Waher.Script.Cryptography.Functions.HashFunctions
{
	...
	/// Sha3_224(Data)
	/// </summary>
	public class Sha3_224 : FunctionOneScalarVariable
	{
		/// <summary>
		/// Sha3_224(Data)
		/// </summary>
		...
		public Sha3_224(ScriptNode Data, int Start, int Length, Expression Expression)
		...
		/// </summary>
		public override string FunctionName => nameof(Sha3_224);
