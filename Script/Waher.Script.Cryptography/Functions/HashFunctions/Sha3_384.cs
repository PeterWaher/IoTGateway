...
namespace Waher.Script.Cryptography.Functions.HashFunctions
{
	...
	/// Sha3_384(Data)
	/// </summary>
	public class Sha3_384 : FunctionOneScalarVariable
	{
		/// <summary>
		/// Sha3_384(Data)
		/// </summary>
		...
		public Sha3_384(ScriptNode Data, int Start, int Length, Expression Expression)
		...
		/// </summary>
		public override string FunctionName => nameof(Sha3_384);
