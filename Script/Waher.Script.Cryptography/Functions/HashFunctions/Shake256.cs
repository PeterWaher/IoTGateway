...
namespace Waher.Script.Cryptography.Functions.HashFunctions
{
	...
	/// Shake256(Bits,Data)
	/// </summary>
	public class Shake256 : FunctionTwoScalarVariables
	{
		/// <summary>
		/// Shake256(Bits,Data)
		/// </summary>
		...
		public Shake256(ScriptNode Bits, ScriptNode Data, int Start, int Length, Expression Expression)
		...
		/// </summary>
		public override string FunctionName => nameof(Shake256);
