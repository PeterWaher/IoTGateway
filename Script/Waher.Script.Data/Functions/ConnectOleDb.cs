...
namespace Waher.Script.Data.Functions
{
	...
	/// </summary>
	public class ConnectOleDb : FunctionMultiVariate
	{
		/// <summary>
		/// Creates a connection to an external OLE DB database.
		/// </summary>
		...
		public ConnectOleDb(ScriptNode ConnectionString, int Start, int Length, Expression Expression)
		...
		/// <param name="Length">Length of expression covered by node.</param>
		/// <param name="Expression">Expression.</param>
		public ConnectOleDb(ScriptNode ConnectionString, ScriptNode UserName, ScriptNode Password, int Start, int Length, Expression Expression)
		...
		public override async Task<IElement> EvaluateAsync(IElement[] Arguments, Variables Variables)
		{
			...
			return new ObjectValue(new OleDbDatabase(Connection));
		}
	}
}
