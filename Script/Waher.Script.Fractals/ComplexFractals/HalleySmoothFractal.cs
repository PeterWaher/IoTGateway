...
namespace Waher.Script.Fractals.ComplexFractals
{
	...
	/// </summary>
	/// <example>
	/// HalleySmoothFractal((0,0),3,,[-1,0,0,1])
	/// HalleySmoothFractal((0,0),3,,[-1,0,1])
	/// HalleySmoothFractal((0,0),3,,[-1,0,0,0,1])
	/// HalleySmoothFractal((0,0),3,,[-1,0,0,0,0,1])
	/// HalleySmoothFractal((0,0),3,,[-1,0,0,0,0,0,1])
	/// HalleySmoothFractal((0,0),3,,[-1,0,0,0,0,0,0,1])
	/// HalleySmoothFractal((0,0),5,,[2,-2,0,1])
	/// HalleySmoothFractal((0,0),5,,[-16,0,0,0,15,0,0,0,1])
	/// HalleySmoothFractal((0,0),10,,[-16,0,0,0,15,0,0,0,1])
	/// HalleySmoothFractal((-0.0732421875,0.0557911132812496),0.0029296875,,[1, 0, 0, 4, 0, 0, 0, 15],,640,480)
	/// HalleySmoothFractal((0,0),3,,Uniform(0,5,8),,640,480)
	/// HalleySmoothFractal((0,0),3,,Uniform(0,5,8),RandomLinearRGB(1024,4,1325528060), 640,480)
	/// HalleySmoothFractal((-0.25755615234375,-0.03313134765625),0.01171875,,[1.95727631540842, 2.08149014137755, 2.98667318559562, 1.07363583337219, 4.51716111251952, 1.92312554545846, 4.77838875482715, 3.5401921014023],RandomLinearRGB(128,8,1738551375),640,480)
	/// 
	/// Generalized Halley Fractals:
	/// HalleySmoothFractal((0,0),3,0.5,[-1,0,0,1],,640,480)
	/// HalleySmoothFractal((0,0),3,1.5,[-1,0,0,1],,640,480)
	/// HalleySmoothFractal((0,0),3,0.5,Uniform(0,5,8),,640,480)
	/// HalleySmoothFractal((0,0),3,1.5,Uniform(0,5,8),,640,480)
	/// 
	/// Using Lambda expressions:
	/// HalleySmoothFractal((pi/2,0),pi/4,,x->sin(x),RandomLinearRGB(128,16,1177860657),640,480)
	/// </example>
	public class HalleySmoothFractal : FunctionMultiVariate
	{
		...
		private string FractalZoomScript(double r, double i, double Size, object State)
		{
			...
			else if (Parameters[4] is double[] Coefficients)
		...
		{
			get { return "HalleySmoothFractal"; }
		}
	}
}
