...
namespace Waher.Script.Fractals.ComplexFractals
{
    ...
    /// </summary>
    /// <example>
    /// MandelbrotSmoothDiffFractal(-0.797597887030777,-0.179388176437736,1.70530256582425E-13,randomlinearrgb(10240,16,1),640,480)
    /// MandelbrotSmoothDiffFractal((-1,0),,3,RandomLinearRgb(1024,16,1),800,600)
    /// MandelbrotSmoothDiffFractal((-0.65,-0.4125),,0.001,RandomLinearRGB(4096,128))
    /// MandelbrotSmoothDiffFractal((-0.728474426269531,-0.240391845703126),,0.000732421875,RandomLinearRGB(4096,128,1325528060),640,480)
    /// MandelbrotSmoothDiffFractal((-0.797603011131287,-0.179388891220092),,1.1444091796875E-05,randomlinearrgb(10240,16,1),320,200)
    /// 
    /// General version:
    /// MandelbrotSmoothDiffFractal((0,0),(z,c)->z^3+c,4,RandomLinearAnalogousHsl(1024,16,21),400,400)
    /// </example>
    public class MandelbrotSmoothDiffFractal : FunctionMultiVariate
    {
		public MandelbrotSmoothDiffFractal(ScriptNode z, ScriptNode f, ScriptNode dr, ScriptNode Palette,
		...
		public MandelbrotSmoothDiffFractal(ScriptNode z, ScriptNode f, ScriptNode dr, ScriptNode Palette, int Start, int Length, Expression Expression)
		...
		public MandelbrotSmoothDiffFractal(ScriptNode z, ScriptNode f, ScriptNode dr, int Start, int Length, Expression Expression)
		...
		public override IElement Evaluate(IElement[] Arguments, Variables Variables)
        {
            ...
            if (i < c)
            {
                throw new ScriptRuntimeException("Parameter mismatch in call to MandelbrotSmoothDiffFractal(r,c,dr[,Palette][,dimx[,dimy]]).",
                    this);
            }
        ...
        private string FractalZoomScript(double r, double i, double Size, object State)
        {
            ...
            sb.Append("MandelbrotSmoothDiffFractal(");
        ...
        public override string FunctionName => nameof(MandelbrotSmoothDiffFractal);
