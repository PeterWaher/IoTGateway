...
namespace Waher.Script.Fractals.ComplexFractals
{
    ...
    /// </summary>
    /// <example>
    /// MandelbrotSmoothFractal((-1,0),,3,RandomLinearRgb(1024,16,1),800,600)
    /// MandelbrotSmoothFractal((-0.65,-0.4125),,0.001,RandomLinearRGB(4096,128))
    /// MandelbrotSmoothFractal((-0.728474426269531,-0.240391845703126),,0.000732421875,RandomLinearRGB(4096,128,1325528060),640,480)
    /// MandelbrotSmoothFractal((-0.797603011131287,-0.179388891220092),,1.1444091796875E-05,randomlinearrgb(10240,16,1),320,200)
    /// 
    /// General version:
    /// MandelbrotSmoothFractal((0,0),(z,c)->z^3+c,4,RandomLinearAnalogousHsl(1024,16,21),400,400)
    /// </example>
    public class MandelbrotSmoothFractal : FunctionMultiVariate
    {
		public MandelbrotSmoothFractal(ScriptNode z, ScriptNode f, ScriptNode dr, ScriptNode Palette,
		...
		public MandelbrotSmoothFractal(ScriptNode z, ScriptNode f, ScriptNode dr, ScriptNode Palette, int Start, int Length, Expression Expression)
		...
		public MandelbrotSmoothFractal(ScriptNode z, ScriptNode f, ScriptNode dr, int Start, int Length, Expression Expression)
		...
		public override IElement Evaluate(IElement[] Arguments, Variables Variables)
        {
            ...
            {
                Palette = ColorModels.RandomLinearAnalogousHSL.CreatePalette(1024, 16, out int Seed, this);
            ...
            if (i < c)
            {
                throw new ScriptRuntimeException("Parameter mismatch in call to MandelbrotSmoothFractal(r,c,dr[,Palette][,dimx[,dimy]]).",
                    this);
            }
        ...
        private string FractalZoomScript(double r, double i, double Size, object State)
        {
            ...
            sb.Append("MandelbrotSmoothFractal(");
        ...
        {
            get { return "MandelbrotSmoothFractal"; }
        }
