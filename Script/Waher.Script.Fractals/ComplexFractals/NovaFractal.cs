...
namespace Waher.Script.Fractals.ComplexFractals
{
    ...
    /// </summary>
    /// <example>
    /// NovaFractal(0,0,3,1,2)
    /// NovaFractal(0,0,3,1,3)
    /// NovaFractal(0,0,3,1,5)
    /// NovaFractal(0,0,3,1,6,,640,480)
    /// NovaFractal(0,0,3,1,7,,640,480)
    /// NovaFractal(0,0,3,1,8,,640,480)
    /// 
    /// Generalized Nova Fractals:
    /// NovaFractal(0,0,3,0.5,2,,640,480)
    /// NovaFractal(0,0,3,1.5,3,,640,480)
    /// NovaFractal(0,0,3,1.5,4,,640,480)
    /// 
    /// NovaFractal(-0.0238669395446776,-0.322384971618653,4.57763671875E-05,1,4+3*i,randomlinearrgb(1024,12,976253670),1024,768)
    /// </example>
    public class NovaFractal : FunctionMultiVariate
    {
		/// <summary>
		/// TODO
		/// </summary>
		public NovaFractal(ScriptNode r, ScriptNode i, ScriptNode dr, ScriptNode R, ScriptNode p, 
		...
		/// TODO
		/// </summary>
		public override string FunctionName => nameof(NovaFractal);
    }
}
