...
namespace Waher.Script.Fractals.ComplexFractals
{
    ...
    /// </summary>
    /// <example>
    /// NovaJuliaSmoothFractal(0,0,0.1,0,3,0.5,5.2,randomlinearrgb(1024,16,1045274576),320,200)
    /// </example>
    public class NovaJuliaSmoothFractal : FunctionMultiVariate
    {
		public NovaJuliaSmoothFractal(ScriptNode r, ScriptNode i, ScriptNode r0, ScriptNode i0, ScriptNode dr,
		...
		public override IElement Evaluate(IElement[] Arguments, Variables Variables)
        {
            ...
            if (i < c)
            {
                throw new ScriptRuntimeException("Parameter mismatch in call to NovaJuliaSmoothFractal(r,c,r0,i0,dr,Coefficients[,Palette][,dimx[,dimy]]).",
                    this);
            }
        ...
        private string FractalZoomScript(double r, double i, double Size, object State)
        {
            ...
            sb.Append("NovaJuliaSmoothFractal(");
        ...
        {
            get { return "NovaJuliaSmoothFractal"; }
        }
    }
}
