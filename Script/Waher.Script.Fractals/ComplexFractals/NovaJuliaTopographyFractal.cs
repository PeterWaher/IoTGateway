...
namespace Waher.Script.Fractals.ComplexFractals
{
    ...
    /// </summary>
    /// <example>
    /// NovaJuliaTopographyFractal(0,0,0.1,0,3,0.5,5.2,randomlinearrgb(1024,16,1045274576),320,200)
    /// </example>
    public class NovaJuliaTopographyFractal : FunctionMultiVariate
    {
		...
		public override IElement Evaluate(IElement[] Arguments, Variables Variables)
        {
            ...
            if (i < c)
            {
                throw new ScriptRuntimeException("Parameter mismatch in call to NovaJuliaTopographyFractal(r,c,r0,i0,dr,Coefficients[,Palette][,dimx[,dimy]]).",
                    this);
            }
        ...
        private string FractalZoomScript(double r, double i, double Size, object State)
        {
            ...
            sb.Append("NovaJuliaTopographyFractal(");
		...
		/// TODO
		/// </summary>
		public static FractalGraph CalcNovaJulia(Variables Variables, double rCenter, double iCenter, double R0, double I0,
            double rDelta, double Rr, double Ri, double pr, double pi, SKColor[] Palette, int Width, int Height, ScriptNode Node,
