...
namespace Waher.Script.Fractals.ComplexFractals
{
    ...
    /// </summary>
    /// <example>
    /// NovaMandelbrotSmoothFractal(0,0,3,1,3,randomlinearrgb(1024,16,385585420),300,300)
    /// </example>
    public class NovaMandelbrotSmoothFractal : FunctionMultiVariate
    {
		/// <summary>
		/// TODO
		/// </summary>
		public NovaMandelbrotSmoothFractal(ScriptNode r, ScriptNode i, ScriptNode dr, ScriptNode R, ScriptNode p,
		...
		public override async Task<IElement> EvaluateAsync(IElement[] Arguments, Variables Variables)
		{
            ...
            if (i < c)
            {
                throw new ScriptRuntimeException("Parameter mismatch in call to NovaMandelbrotSmoothFractal(r,c,dr,Coefficients[,Palette][,dimx[,dimy]]).",
                    this);
            }
            ...
            return await CalcNovaMandelbrot(rc, ic, dr, Rr, Ri, pr, pi, Palette, dimx, dimy, 
        ...
        private string FractalZoomScript(double r, double i, double Size, object State)
        {
            ...
            sb.Append("NovaMandelbrotSmoothFractal(");
		...
		/// TODO
		/// </summary>
		public static async Task<FractalGraph> CalcNovaMandelbrot(double rCenter, double iCenter, double rDelta, double Rr, double Ri,
