...
namespace Waher.Script.Fractals.ComplexFractals
{
    ...
    /// </summary>
    /// <example>
    /// NovaMandelbrotTopographyFractal(0,0,3,1,3,randomlinearrgb(1024,16,385585420),300,300)
    /// </example>
    public class NovaMandelbrotTopographyFractal : FunctionMultiVariate
    {
		...
		public override IElement Evaluate(IElement[] Arguments, Variables Variables)
        {
            ...
            if (i < c)
            {
                throw new ScriptRuntimeException("Parameter mismatch in call to NovaMandelbrotTopographyFractal(r,c,dr,Coefficients[,Palette][,dimx[,dimy]]).",
                    this);
            }
        ...
        private string FractalZoomScript(double r, double i, double Size, object State)
        {
            ...
            sb.Append("NovaMandelbrotTopographyFractal(");
        ...
        {
            get { return "NovaMandelbrotTopographyFractal"; }
        }
    }
}
