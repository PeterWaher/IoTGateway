...
namespace Waher.Script.Fractals.ComplexFractals
{
    ...
    /// </summary>
    /// <example>
    /// NovaTopographyFractal(0,0,3,1,2)
    /// NovaTopographyFractal(0,0,3,1,3)
    /// NovaTopographyFractal(0,0,3,1,5)
    /// NovaTopographyFractal(0,0,3,1,6,,640,480)
    /// NovaTopographyFractal(0,0,3,1,7,,640,480)
    /// NovaTopographyFractal(0,0,3,1,8,,640,480)
    /// 
    /// Generalized Nova Fractals:
    /// NovaTopographyFractal(0,0,3,0.5,2,,640,480)
    /// NovaTopographyFractal(0,0,3,1.5,3,,640,480)
    /// NovaTopographyFractal(0,0,3,1.5,4,,640,480)
    /// 
    /// NovaTopographyFractal(-0.0238669395446776,-0.322384971618653,4.57763671875E-05,1,4+3*i,randomlinearrgb(1024,12,976253670),1024,768)
    /// </example>
    public class NovaTopographyFractal : FunctionMultiVariate
    {
		/// <summary>
		/// TODO
		/// </summary>
		public NovaTopographyFractal(ScriptNode r, ScriptNode i, ScriptNode dr, ScriptNode R, ScriptNode p,
        ...
        private string FractalZoomScript(double r, double i, double Size, object State)
        {
            ...
            sb.Append("NovaTopographyFractal(");
		...
		/// TODO
		/// </summary>
		public override string FunctionName => nameof(NovaTopographyFractal);
    }
}
