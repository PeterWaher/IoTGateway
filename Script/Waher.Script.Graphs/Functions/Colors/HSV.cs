...
namespace Waher.Script.Graphs.Functions.Colors
{
	...
	{
		public HSV(ScriptNode H, ScriptNode S, ScriptNode V, int Start, int Length)
			: base(new ScriptNode[] { H, S, V }, FunctionMultiVariate.argumentTypes3Scalar, Start, Length)
		{
		}
