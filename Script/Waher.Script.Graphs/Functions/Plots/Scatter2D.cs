...
namespace Waher.Script.Graphs.Functions.Plots
{
	...
	public class Scatter2D : FunctionMultiVariate
	{
		...
		/// </summary>
		public override string FunctionName => nameof(Scatter2D);
		...
		public override IElement Evaluate(IElement[] Arguments, Variables Variables)
		{
			...
			return new Graph2D(Variables, X, Y, new Scatter2DPainter(), false, false, this,
				Color?.AssociatedObjectValue ?? Graph.DefaultColor, Size?.AssociatedObjectValue ?? 5.0);
		}
	}
}
