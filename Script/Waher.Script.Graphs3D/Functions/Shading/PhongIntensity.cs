...
namespace Waher.Script.Graphs3D.Functions.Shading
{
	...
	/// </summary>
	public class PhongIntensity : FunctionMultiVariate
	{
		/// <summary>
		/// Generates a <see cref="Graphs3D.PhongIntensity"/> object.
		/// </summary>
		...
		public PhongIntensity(ScriptNode Color, int Start, int Length, Expression Expression)
		...
		/// <param name="Length">Length of expression covered by node.</param>
		/// <param name="Expression">Expression.</param>
		public PhongIntensity(ScriptNode Red, ScriptNode Green, ScriptNode Blue,
		...
		/// </summary>
		public override string FunctionName => nameof(PhongIntensity);
		...
		public override IElement Evaluate(IElement[] Arguments, Variables Variables)
		{
			switch (Arguments.Length)
			{
				case 1:
					...
					return new ObjectValue(new Graphs3D.PhongIntensity(
