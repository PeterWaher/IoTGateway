...
namespace Waher.Script.Persistence.SQL.Sources
{
    ...
    public abstract class JoinedSource : IDataSource
	{
		...
		public abstract Task<bool> Process(IProcessor<object> Processor, int Offset, int Top, bool Generic,
		...
		public Task<int?> Delete(bool Lazy, int Offset, int Top, ScriptNode Where, Variables Variables,
			KeyValuePair<VariableReference, bool>[] Order, ScriptNode Node)
		{
			throw InvalidOperation();
		}
