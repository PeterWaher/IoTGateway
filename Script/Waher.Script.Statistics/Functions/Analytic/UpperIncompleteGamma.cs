...
{
	/// <summary>
	/// Upper Incomplete Gamma function Γ(a,z)
	/// </summary>
	public class UpperIncompleteGamma : FunctionTwoScalarVariables
	{
		/// <summary>
		/// Upper Incomplete Gamma function Γ(a,z)
		/// </summary>
		...
		public UpperIncompleteGamma(ScriptNode Argument1, ScriptNode Argument2, 
		...
		/// </summary>
		public override string[] Aliases => new string[] { "ugamma" };
