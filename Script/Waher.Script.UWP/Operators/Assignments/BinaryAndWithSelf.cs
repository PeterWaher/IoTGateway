...
namespace Waher.Script.Operators.Assignments
{
	...
	public class BinaryAndWithSelf : Assignment 
	{
        ...
        public BinaryAndWithSelf(string VariableName, ScriptNode Operand, int Start, int Length)
			: base(VariableName, Operand, Start, Length)
		{
            this.and = new And(new VariableReference(VariableName, true, Start, Length), Operand, Start, Length);
        }
