...
namespace Waher.Script.Functions.Analytic
{
	...
	/// ArcCot(x)
	/// </summary>
	public class ArcCot : FunctionOneScalarVariable, IDifferentiable
	{
		/// <summary>
		/// ArcCot(x)
		/// </summary>
		...
		public ArcCot(ScriptNode Argument, int Start, int Length, Expression Expression)
		...
		/// </summary>
		public override string FunctionName => nameof(ArcCot);
		...
		{
			return new DoubleNumber(Math.Atan(1.0 / Argument));
		}
		...
		{
			return new ComplexNumber(Complex.Atan(Complex.Reciprocal(Argument)));
		}
	}
}
