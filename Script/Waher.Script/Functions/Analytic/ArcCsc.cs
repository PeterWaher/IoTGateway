...
namespace Waher.Script.Functions.Analytic
{
    ...
    /// ArcCsc(x)
    /// </summary>
    public class ArcCsc : FunctionOneScalarVariable
    {
        /// <summary>
        /// ArcCsc(x)
        /// </summary>
        ...
        public ArcCsc(ScriptNode Argument, int Start, int Length)
        ...
        {
            return new ComplexNumber(Complex.Asin(Complex.One / Argument));
        }
    }
}
