...
namespace Waher.Script.Functions.Analytic
{
    ...
    /// ArcSec(x)
    /// </summary>
    public class ArcSec : FunctionOneScalarVariable
    {
        /// <summary>
        /// ArcSec(x)
        /// </summary>
        ...
        public ArcSec(ScriptNode Argument, int Start, int Length)
        ...
        {
            return new ComplexNumber(Complex.Acos(Complex.One / Argument));
        }
    }
}
