...
namespace Waher.Script.Functions.Analytic
{
	...
	/// ArcSin(x)
	/// </summary>
	public class ArcSin : FunctionOneScalarVariable, IDifferentiable
	{
		/// <summary>
		/// ArcSin(x)
		/// </summary>
		...
		public ArcSin(ScriptNode Argument, int Start, int Length, Expression Expression)
		...
		/// </summary>
		public override string FunctionName => nameof(ArcSin);
		...
		{
			return new DoubleNumber(Math.Asin(Argument));
		}
		...
		{
			return new ComplexNumber(Complex.Asin(Argument));
		}
	}
}
