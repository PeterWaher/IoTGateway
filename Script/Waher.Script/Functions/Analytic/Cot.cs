...
namespace Waher.Script.Functions.Analytic
{
	...
	/// Cot(x)
	/// </summary>
	public class Cot : FunctionOneScalarVariable, IDifferentiable
	{
		/// <summary>
		/// Cot(x)
		/// </summary>
		...
		public Cot(ScriptNode Argument, int Start, int Length, Expression Expression)
		...
		/// </summary>
		public override string FunctionName => nameof(Cot);
