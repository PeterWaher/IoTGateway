...
namespace Waher.Script.Functions.Analytic
{
    ...
    /// SecH(x)
    /// </summary>
    public class SecH : FunctionOneScalarVariable
    {
        /// <summary>
        /// SecH(x)
        /// </summary>
        ...
        public SecH(ScriptNode Argument, int Start, int Length)
        ...
        {
            return new ComplexNumber(Complex.One / Complex.Cosh(Argument));
        }
    }
}
