...
namespace Waher.Script.Functions.Analytic
{
	...
	/// SinH(x)
	/// </summary>
	public class SinH : FunctionOneScalarVariable, IDifferentiable
	{
		/// <summary>
		/// SinH(x)
		/// </summary>
		...
		public SinH(ScriptNode Argument, int Start, int Length, Expression Expression)
		...
		/// </summary>
		public override string FunctionName => nameof(SinH);
		...
		{
			return new DoubleNumber(Math.Sinh(Argument));
		}
		...
		{
			return new ComplexNumber(Complex.Sinh(Argument));
		}
	}
}
