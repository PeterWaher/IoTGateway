...
namespace Waher.Script.Functions.Logging
{
	...
	/// </summary>
	public class LogAlert : LogFunction
	{
		/// <summary>
		/// Logs an alert event to the event log.
		/// </summary>
		...
		public LogAlert(ScriptNode Message, int Start, int Length, Expression Expression)
		...
		/// <param name="Length">Length of expression covered by node.</param>
		/// <param name="Expression">Expression containing script.</param>
		public LogAlert(ScriptNode Message, ScriptNode Tags, int Start, int Length, Expression Expression)
		...
		/// </summary>
		public override string FunctionName => nameof(LogAlert);
		...
		{
			Log.Alert(Message, Object, Actor, EventId, Level, Facility, Module, StackTrace, Tags);
		}
	}
}
