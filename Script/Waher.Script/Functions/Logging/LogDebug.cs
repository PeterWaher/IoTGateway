...
namespace Waher.Script.Functions.Logging
{
	...
	/// </summary>
	public class LogDebug : LogFunction
	{
		/// <summary>
		/// Logs a debug event to the event log.
		/// </summary>
		...
		public LogDebug(ScriptNode Message, int Start, int Length, Expression Expression)
		...
		/// <param name="Length">Length of expression covered by node.</param>
		/// <param name="Expression">Expression containing script.</param>
		public LogDebug(ScriptNode Message, ScriptNode Tags, int Start, int Length, Expression Expression)
		...
		/// </summary>
		public override string FunctionName => nameof(LogDebug);
		...
		{
			Log.Debug(Message, Object, Actor, EventId, Level, Facility, Module, StackTrace, Tags);
		}
	}
}
