...
namespace Waher.Script.Functions.Logging
{
	...
	/// </summary>
	public class LogEmergency : LogFunction
	{
		/// <summary>
		/// Logs an emergency event to the event log.
		/// </summary>
		...
		public LogEmergency(ScriptNode Message, int Start, int Length, Expression Expression)
		...
		/// <param name="Length">Length of expression covered by node.</param>
		/// <param name="Expression">Expression containing script.</param>
		public LogEmergency(ScriptNode Message, ScriptNode Tags, int Start, int Length, Expression Expression)
		...
		/// </summary>
		public override string FunctionName => nameof(LogEmergency);
		...
		{
			Log.Emergency(Message, Object, Actor, EventId, Level, Facility, Module, StackTrace, Tags);
		}
	}
}
