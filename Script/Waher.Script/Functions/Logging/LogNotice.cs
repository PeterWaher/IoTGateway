...
namespace Waher.Script.Functions.Logging
{
	...
	/// </summary>
	public class LogNotice : LogFunction
	{
		/// <summary>
		/// Logs a notice event to the event log.
		/// </summary>
		...
		public LogNotice(ScriptNode Message, int Start, int Length, Expression Expression)
		...
		/// <param name="Length">Length of expression covered by node.</param>
		/// <param name="Expression">Expression containing script.</param>
		public LogNotice(ScriptNode Message, ScriptNode Tags, int Start, int Length, Expression Expression)
		...
		/// </summary>
		public override string FunctionName => nameof(LogNotice);
		...
		{
			Log.Notice(Message, Object, Actor, EventId, Level, Facility, Module, StackTrace, Tags);
		}
	}
}
