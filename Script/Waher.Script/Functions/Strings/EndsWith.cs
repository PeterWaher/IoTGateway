...
namespace Waher.Script.Functions.Strings
{
	...
	/// </summary>
	public class EndsWith : FunctionTwoScalarVariables
	{
		/// <summary>
		/// EndsWith(String,Substring)
		/// </summary>
		...
		public EndsWith(ScriptNode String, ScriptNode Substring, int Start, int Length, Expression Expression)
		...
		{
			return Argument1.EndsWith(Argument2) ? BooleanValue.True : BooleanValue.False;
		}
	}
}
