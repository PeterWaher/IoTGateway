...
{
	/// <summary>
	/// Creates a scaling matrix in 2-dimensional homogenous coordinates.
	/// </summary>
	public class Scale2DH : FunctionTwoScalarVariables
	{
		...
		/// </summary>
		public override string FunctionName => nameof(Scale2DH);

		/// <summary>
		/// Default Argument names
		/// </summary>
		public override string[] DefaultArgumentNames => new string[] { "sx", "sy" };
