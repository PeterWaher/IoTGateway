...
namespace Waher.Script.Functions.Vectors
{
    ...
    /// And(v)
    /// </summary>
    public class And : FunctionOneVectorVariable, IIterativeEvaluation
	{
        /// <summary>
        /// And(v)
        /// </summary>
        ...
        public And(ScriptNode Argument, int Start, int Length, Expression Expression)
        ...
        /// </summary>
        public override string FunctionName => nameof(And);
        ...
        {
            return new DoubleNumber(CalcAnd(Argument.Values, this));
        }
        ...
        public static double CalcAnd(double[] Values, ScriptNode Node)
        {
            double d;
            ulong Result;
        ...
        {
            return new BooleanValue(CalcAnd(Argument.Values, this));
        }
        ...
        /// <param name="Node">Node performing the evaluation.</param>
        /// <returns>And(Values)</returns>
        public static bool CalcAnd(bool[] Values, ScriptNode Node)
        {
            int i, c = Values.Length;
		...
		public override IIterativeEvaluator CreateEvaluator() => new AndEvaluator(this);
	}
}
