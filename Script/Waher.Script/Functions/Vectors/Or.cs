...
namespace Waher.Script.Functions.Vectors
{
    ...
    /// Or(v)
    /// </summary>
    public class Or : FunctionOneVectorVariable, IIterativeEvaluation
	{
        /// <summary>
        /// Or(v)
        /// </summary>
        ...
        public Or(ScriptNode Argument, int Start, int Length, Expression Expression)
        ...
        {
            return new DoubleNumber(CalcOr(Argument.Values, this));
        }
        ...
        public static double CalcOr(double[] Values, ScriptNode Node)
        {
            double d;
            ulong Result;
        ...
        {
            return new BooleanValue(CalcOr(Argument.Values, this));
        }
        ...
        /// <param name="Node">Node performing the evaluation.</param>
        /// <returns>Or(Values)</returns>
        public static bool CalcOr(bool[] Values, ScriptNode Node)
        {
            int i, c = Values.Length;
