...
namespace Waher.Script.Functions.Vectors
{
    ...
    public class StandardDeviation : FunctionOneVectorVariable, IIterativeEvaluation
    {
        ...
        public StandardDeviation(ScriptNode Argument, int Start, int Length, Expression Expression)
        ...
        /// </summary>
        public override string FunctionName => nameof(StandardDeviation);
		...
		public override IIterativeEvaluator CreateEvaluator() => new StandardDeviationEvaluator(this);
	}
}
