        ...
        public override IElement Evaluate(IElement Argument1, IElement Argument2, Variables Variables)
        {
            if (Argument1.IsScalar)
            {
                if (Argument2.IsScalar)
                {
					...
					if (Argument1 is ComplexNumber ComplexNumber1 && Argument2 is ComplexNumber ComplexNumber2)
						return this.EvaluateScalar(ComplexNumber1.Value, ComplexNumber2.Value, Variables);

					if (Argument1 is BooleanValue BooleanValue1 && Argument2 is BooleanValue BooleanValue2)
						return this.EvaluateScalar(BooleanValue1.Value, BooleanValue2.Value, Variables);

					if (Argument1 is StringValue StringValue1 && Argument2 is StringValue StringValue2)
        ...
        public override async Task<IElement> EvaluateAsync(IElement Argument1, IElement Argument2, Variables Variables)
        {
            if (Argument1.IsScalar)
            {
                if (Argument2.IsScalar)
                {
                    ...
                    DoubleNumber DoubleNumber2 = Argument2 as DoubleNumber;
                    if (!(DoubleNumber1 is null) && !(DoubleNumber2 is null))
                        return await this.EvaluateScalarAsync(DoubleNumber1.Value, DoubleNumber2.Value, Variables);

                    if (Argument1 is ComplexNumber ComplexNumber1 && Argument2 is ComplexNumber ComplexNumber2)
                        return await this.EvaluateScalarAsync(ComplexNumber1.Value, ComplexNumber2.Value, Variables);

                    if (Argument1 is BooleanValue BooleanValue1 && Argument2 is BooleanValue BooleanValue2)
                        return await this.EvaluateScalarAsync(BooleanValue1.Value, BooleanValue2.Value, Variables);
