	...
	public sealed class ComplexMatrix : RingElement, IMatrix
	{
		...
		public bool TryFind(IElement Element, int FromColumn, int FromRow, out int Column, out int Row)
		{
			if (Element is ComplexNumber Z)
				return this.TryFind(Z.Value, FromColumn, FromRow, out Column, out Row);
			else
			{
				Column = -1;
				Row = -1;
		...
		/// <param name="Row">Row, if found.</param>
		/// <returns>If element was found.</returns>
		public bool TryFind(Complex Element, int FromColumn, int FromRow, out int Column, out int Row)
		{
			Complex[,] Values = this.Values;
		...
		{
			if (Element is ComplexNumber Z)
				return this.TryFindLast(Z.Value, FromColumn, FromRow, out Column, out Row);
			else
			{
				Column = -1;
				Row = -1;
		...
		/// <param name="Row">Row, if found.</param>
		/// <returns>If element was found.</returns>
		public bool TryFindLast(Complex Element, int FromColumn, int FromRow, out int Column, out int Row)
		{
			Complex[,] Values = this.Values;
