...
namespace Waher.Script.Objects.Sets
{
    ...
    /// </summary>
    public sealed class UnionSet : Set
    {
        private ISet set1;
        private ISet set2;
        ...
        public UnionSet(ISet Set1, ISet Set2)
        {
            this.set1 = Set1;
            this.set2 = Set2;
        }
        ...
        public override ICollection<IElement> ChildElements
        {
            get
            {
                ...
                ICollection<IElement> E2 = this.set2.ChildElements;
                if (E2 is null)
                    return null;
