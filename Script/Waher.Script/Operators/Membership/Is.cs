	...
	public class Is : BinaryScalarOperator
    {
        ...
        public override IElement Evaluate(IElement Left, IElement Right, Variables Variables)
        {
            if (Right is TypeValue TypeValue)
                return this.EvaluateIs(Left, TypeValue);
            else
                return base.Evaluate(Left, Right, Variables);
        }

        private BooleanValue EvaluateIs(IElement Left, TypeValue Right)
		{
        ...
        {
            if (Right is TypeValue TypeValue)
                return Task.FromResult<IElement>(this.EvaluateIs(Left, TypeValue));
            else
