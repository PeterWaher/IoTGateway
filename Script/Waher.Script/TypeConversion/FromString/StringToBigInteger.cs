...
{
	/// <summary>
	/// Converts a string value to a <see cref="BigInteger"/>, if possible.
	/// </summary>
	public class StringToBigInteger : ITypeConverter
	{
		/// <summary>
		...
		{
			if (Value is string s && BigInteger.TryParse(s, out BigInteger i))
			{
				Result = i;
				return true;
			}
