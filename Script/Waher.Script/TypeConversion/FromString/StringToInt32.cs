...
{
	/// <summary>
	/// Converts string values to 32-bit integer values.
	/// </summary>
	public class StringToInt32 : ITypeConverter
	{
		/// <summary>
		/// Converts string values to 32-bit integer values.
		/// </summary>
		...
		{
			if (Value is string s && int.TryParse(s, NumberStyles.Integer, null, out int i))
			{
				Result = i;
				return true;
			}
