...
{
	/// <summary>
	/// Converts string values to 32-bit unsigned integer values.
	/// </summary>
	public class StringToUInt32 : ITypeConverter
	{
		/// <summary>
		/// Converts string values to 32-bit unsigned integer values.
		/// </summary>
		...
		{
			if (Value is string s && uint.TryParse(s, NumberStyles.Integer, null, out uint i))
			{
				Result = i;
				return true;
			}
