...
{
	/// <summary>
	/// Converts string values to 8-bit unsigned integer values.
	/// </summary>
	public class StringToUInt8 : ITypeConverter
	{
		/// <summary>
		/// Converts string values to 8-bit unsigned integer values.
		/// </summary>
		...
		{
			if (Value is string s && byte.TryParse(s, NumberStyles.Integer, null, out byte i))
			{
				Result = i;
				return true;
			}
