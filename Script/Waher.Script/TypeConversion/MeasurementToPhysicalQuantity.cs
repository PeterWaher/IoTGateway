...
{
	/// <summary>
	/// Converts a <see cref="Measurement"/> to a <see cref="PhysicalQuantity"/>.
	/// </summary>
	public class MeasurementToPhysicalQuantity : ITypeConverter
	{
		/// <summary>
		...
		public bool TryConvert(object Value, out object Result)
		{
			...
			{
				Result = new PhysicalQuantity(Q.Magnitude, Q.Unit);
				return true;
			}
			else
			{
