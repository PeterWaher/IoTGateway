...
namespace Waher.Security.EllipticCurves.Test
{
	...
	public class EcdhTests
	{
		...
		[TestMethod]
		public void Test_17_Brainpool_P224_RFC6932()
		{
			BrainpoolP224 A = new(
			[
			...
			PointOnCurve SharedA = A.GetSharedPoint(B.PublicKey);
			PointOnCurve SharedB = B.GetSharedPoint(A.PublicKey);
		...
		[TestMethod]
		public void Test_18_Brainpool_P256_RFC6932()
		{
			BrainpoolP256 A = new(
			[
		...
		[TestMethod]
		public void Test_19_Brainpool_P384_RFC6932()
		{
			BrainpoolP384 A = new(
			[
		...
		[TestMethod]
		public void Test_20_Brainpool_P512_RFC6932()
		{
			BrainpoolP512 A = new(
			[
