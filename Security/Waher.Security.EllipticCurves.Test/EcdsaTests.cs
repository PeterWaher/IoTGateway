...
namespace Waher.Security.EllipticCurves.Test
{
	...
	public class EcdsaTests
	{
		...
		{
			this.Test_ECDSA(new NistP192(), new NistP192(), HashFunction.SHA256);
		}

		[TestMethod]
		public void Test_02_NIST_P224()
		{
			this.Test_ECDSA(new NistP224(), new NistP224(), HashFunction.SHA256);
		}

		[TestMethod]
		public void Test_03_NIST_P256()
		{
			this.Test_ECDSA(new NistP256(), new NistP256(), HashFunction.SHA256);
		}

		[TestMethod]
		public void Test_04_NIST_P384()
		{
			this.Test_ECDSA(new NistP384(), new NistP384(), HashFunction.SHA512);
		}

		[TestMethod]
		public void Test_05_NIST_P521()
		{
			this.Test_ECDSA(new NistP521(), new NistP521(), HashFunction.SHA512);
		}
