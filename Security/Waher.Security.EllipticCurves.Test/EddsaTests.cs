...
namespace Waher.Security.EllipticCurves.Test
{
    ...
    public class EddsaTests
    {
        ...
        public void Test_01_Ed25519_TestVector_1()
        {
            ...
            byte[] PublicKey = EdDSA.Encode(Curve.PublicKey, Curve);
        ...
        public void Test_02_Ed25519_TestVector_2()
        {
            ...
            byte[] Message = Hashes.StringToBinary("72");
            byte[] Signature = EdDSA.Sign(Message, D, Hashes.ComputeSHA512Hash, 253, Curve);
        ...
        public void Test_03_Ed25519_TestVector_3()
        {
            ...
            byte[] Message = Hashes.StringToBinary("af82");
            byte[] Signature = EdDSA.Sign(Message, D, Hashes.ComputeSHA512Hash, 253, Curve);
        ...
        public void Test_05_Ed25519_TestVector_5()
        {
            ...
            byte[] Message = Hashes.StringToBinary("ddaf35a193617abacc417349ae20413112e6fa4e89a97ea20a9eeee64b55d39a2192992a274fc1a836ba3c23a3feebbd454d4423643ce80e2a9ac94fa54ca49f");
            byte[] Signature = EdDSA.Sign(Message, D, Hashes.ComputeSHA512Hash, 253, Curve);
        ...
        public void Test_06_Ed448_TestVector_1()
        {
            ...
            SecretKey[0] &= 252;
            SecretKey[55] |= 128;
            Array.Resize(ref SecretKey, 57);

            BigInteger D = new BigInteger(SecretKey);
            Edwards448 Curve = new Edwards448(D);
            ...
            SHAKE256 Shake256_114 = new SHAKE256(114 << 3);
            byte[] Message = new byte[0];
            byte[] Signature = EdDSA.Sign(Message, D,
                Bin => Shake256_114.ComputeVariable(Bin), 447, Curve);
        ...
        public void Test_07_Ed448_TestVector_2()
        {
            ...
            SHAKE256 Shake256_114 = new SHAKE256(114 << 3);
            byte[] Message = Hashes.StringToBinary("03");
            byte[] Signature = EdDSA.Sign(Message, D,
                Bin => Shake256_114.ComputeVariable(Bin), 447, Curve);
        ...
        public void Test_08_Ed448_TestVector_3()
        {
            ...
            SHAKE256 Shake256_114 = new SHAKE256(114 << 3);
            byte[] Message = Hashes.StringToBinary("0c3e544074ec63b0265e0c");
            byte[] Signature = EdDSA.Sign(Message, D,
                Bin => Shake256_114.ComputeVariable(Bin), 447, Curve);
        ...
        public void Test_09_Ed448_TestVector_4()
        {
            ...
            SHAKE256 Shake256_114 = new SHAKE256(114 << 3);
            byte[] Message = Hashes.StringToBinary("64a65f3cdedcdd66811e2915");
            byte[] Signature = EdDSA.Sign(Message, D,
                Bin => Shake256_114.ComputeVariable(Bin), 447, Curve);
        ...
        public void Test_10_Ed448_TestVector_5()
        {
            ...
            SHAKE256 Shake256_114 = new SHAKE256(114 << 3);
            byte[] Message = Hashes.StringToBinary("64a65f3cdedcdd66811e2915e7");
            byte[] Signature = EdDSA.Sign(Message, D,
                Bin => Shake256_114.ComputeVariable(Bin), 447, Curve);
        ...
        public void Test_11_Ed448_TestVector_6()
        {
            ...
            SHAKE256 Shake256_114 = new SHAKE256(114 << 3);
            byte[] Message = Hashes.StringToBinary("bd0f6a3747cd561bdddf4640a332461a4a30a12a434cd0bf40d766d9c6d458e5512204a30c17d1f50b5079631f64eb3112182da3005835461113718d1a5ef944");
            byte[] Signature = EdDSA.Sign(Message, D,
                Bin => Shake256_114.ComputeVariable(Bin), 447, Curve);
