...
{
	[TestClass]
	public class LoginAuditorExceptionTests
	{
		...
		public static void ClassInitialize(TestContext _)
		{
			auditor = new LoginAuditor("Login Auditor",
				...
				new LoginInterval(3, TimeSpan.FromHours(1)),    // Maximum 3 failed login attempts in an hour
				new LoginInterval(1, TimeSpan.FromDays(1)),     // Maximum 1x5 failed login attempts in a day
				new LoginInterval(1, TimeSpan.FromDays(7)),     // Maximum 1x1x5 failed login attempts in a week
				new LoginInterval(1, TimeSpan.MaxValue));       // Maximum 1x1x1x5 failed login attempts in total, then blocked.
		}
