    ...
    public abstract class Keccak1600
    {
        ...
        public byte[] ComputeFixed(byte[] S)
        {
            ...
            for (ir = 0; ir < 24; ir++)
            {
                ...
                C[0] = A[0 + 5 * 0] ^ A[0 + 5 * 1] ^ A[0 + 5 * 2] ^ A[0 + 5 * 3] ^ A[0 + 5 * 4];
                C[1] = A[1 + 5 * 0] ^ A[1 + 5 * 1] ^ A[1 + 5 * 2] ^ A[1 + 5 * 3] ^ A[1 + 5 * 4];
                C[2] = A[2 + 5 * 0] ^ A[2 + 5 * 1] ^ A[2 + 5 * 2] ^ A[2 + 5 * 3] ^ A[2 + 5 * 4];
                C[3] = A[3 + 5 * 0] ^ A[3 + 5 * 1] ^ A[3 + 5 * 2] ^ A[3 + 5 * 3] ^ A[3 + 5 * 4];
                C[4] = A[4 + 5 * 0] ^ A[4 + 5 * 1] ^ A[4 + 5 * 2] ^ A[4 + 5 * 3] ^ A[4 + 5 * 4];
                ...
                A[1 + 5 * 0] = ((v = A[1 + 5 * 0]) << 1) | (v >> 63);
                A[0 + 5 * 2] = ((v = A[0 + 5 * 2]) << 3) | (v >> 61);
                A[2 + 5 * 1] = ((v = A[2 + 5 * 1]) << 6) | (v >> 58);
                A[1 + 5 * 2] = ((v = A[1 + 5 * 2]) << 10) | (v >> 54);
                A[2 + 5 * 3] = ((v = A[2 + 5 * 3]) << 15) | (v >> 49);
                A[3 + 5 * 3] = ((v = A[3 + 5 * 3]) << 21) | (v >> 43);
                A[3 + 5 * 0] = ((v = A[3 + 5 * 0]) << 28) | (v >> 36);
                A[0 + 5 * 1] = ((v = A[0 + 5 * 1]) << 36) | (v >> 28);
                A[1 + 5 * 3] = ((v = A[1 + 5 * 3]) << 45) | (v >> 19);
                A[3 + 5 * 1] = ((v = A[3 + 5 * 1]) << 55) | (v >> 9);
                A[1 + 5 * 4] = ((v = A[1 + 5 * 4]) << 2) | (v >> 62);
                A[4 + 5 * 4] = ((v = A[4 + 5 * 4]) << 14) | (v >> 50);
                A[4 + 5 * 0] = ((v = A[4 + 5 * 0]) << 27) | (v >> 37);
                A[0 + 5 * 3] = ((v = A[0 + 5 * 3]) << 41) | (v >> 23);
                A[3 + 5 * 4] = ((v = A[3 + 5 * 4]) << 56) | (v >> 8);
                A[4 + 5 * 3] = ((v = A[4 + 5 * 3]) << 8) | (v >> 56);
                A[3 + 5 * 2] = ((v = A[3 + 5 * 2]) << 25) | (v >> 39);
                A[2 + 5 * 2] = ((v = A[2 + 5 * 2]) << 43) | (v >> 21);
                A[2 + 5 * 0] = ((v = A[2 + 5 * 0]) << 62) | (v >> 2);
                A[0 + 5 * 4] = ((v = A[0 + 5 * 4]) << 18) | (v >> 46);
                A[4 + 5 * 2] = ((v = A[4 + 5 * 2]) << 39) | (v >> 25);
                A[2 + 5 * 4] = ((v = A[2 + 5 * 4]) << 61) | (v >> 3);
                A[4 + 5 * 1] = ((v = A[4 + 5 * 1]) << 20) | (v >> 44);
                A[1 + 5 * 1] = ((v = A[1 + 5 * 1]) << 44) | (v >> 20);
                ...
                A[0 + 5 * 0] = A2[0 + 5 * 0] ^ ((~A2[1 + 5 * 0]) & A2[2 + 5 * 0]);
                A[0 + 5 * 1] = A2[0 + 5 * 1] ^ ((~A2[1 + 5 * 1]) & A2[2 + 5 * 1]);
                A[0 + 5 * 2] = A2[0 + 5 * 2] ^ ((~A2[1 + 5 * 2]) & A2[2 + 5 * 2]);
                A[0 + 5 * 3] = A2[0 + 5 * 3] ^ ((~A2[1 + 5 * 3]) & A2[2 + 5 * 3]);
                A[0 + 5 * 4] = A2[0 + 5 * 4] ^ ((~A2[1 + 5 * 4]) & A2[2 + 5 * 4]);

                A[1 + 5 * 0] = A2[1 + 5 * 0] ^ ((~A2[2 + 5 * 0]) & A2[3 + 5 * 0]);
                A[1 + 5 * 1] = A2[1 + 5 * 1] ^ ((~A2[2 + 5 * 1]) & A2[3 + 5 * 1]);
                A[1 + 5 * 2] = A2[1 + 5 * 2] ^ ((~A2[2 + 5 * 2]) & A2[3 + 5 * 2]);
                A[1 + 5 * 3] = A2[1 + 5 * 3] ^ ((~A2[2 + 5 * 3]) & A2[3 + 5 * 3]);
                A[1 + 5 * 4] = A2[1 + 5 * 4] ^ ((~A2[2 + 5 * 4]) & A2[3 + 5 * 4]);

                A[2 + 5 * 0] = A2[2 + 5 * 0] ^ ((~A2[3 + 5 * 0]) & A2[4 + 5 * 0]);
                A[2 + 5 * 1] = A2[2 + 5 * 1] ^ ((~A2[3 + 5 * 1]) & A2[4 + 5 * 1]);
                A[2 + 5 * 2] = A2[2 + 5 * 2] ^ ((~A2[3 + 5 * 2]) & A2[4 + 5 * 2]);
                A[2 + 5 * 3] = A2[2 + 5 * 3] ^ ((~A2[3 + 5 * 3]) & A2[4 + 5 * 3]);
                A[2 + 5 * 4] = A2[2 + 5 * 4] ^ ((~A2[3 + 5 * 4]) & A2[4 + 5 * 4]);

                A[3 + 5 * 0] = A2[3 + 5 * 0] ^ ((~A2[4 + 5 * 0]) & A2[0 + 5 * 0]);
                A[3 + 5 * 1] = A2[3 + 5 * 1] ^ ((~A2[4 + 5 * 1]) & A2[0 + 5 * 1]);
                A[3 + 5 * 2] = A2[3 + 5 * 2] ^ ((~A2[4 + 5 * 2]) & A2[0 + 5 * 2]);
                A[3 + 5 * 3] = A2[3 + 5 * 3] ^ ((~A2[4 + 5 * 3]) & A2[0 + 5 * 3]);
                A[3 + 5 * 4] = A2[3 + 5 * 4] ^ ((~A2[4 + 5 * 4]) & A2[0 + 5 * 4]);

                A[4 + 5 * 0] = A2[4 + 5 * 0] ^ ((~A2[0 + 5 * 0]) & A2[1 + 5 * 0]);
                A[4 + 5 * 1] = A2[4 + 5 * 1] ^ ((~A2[0 + 5 * 1]) & A2[1 + 5 * 1]);
                A[4 + 5 * 2] = A2[4 + 5 * 2] ^ ((~A2[0 + 5 * 2]) & A2[1 + 5 * 2]);
                A[4 + 5 * 3] = A2[4 + 5 * 3] ^ ((~A2[0 + 5 * 3]) & A2[1 + 5 * 3]);
                A[4 + 5 * 4] = A2[4 + 5 * 4] ^ ((~A2[0 + 5 * 4]) & A2[1 + 5 * 4]);
