...
namespace Waher.Security.TOTP
{
	...
	public class HotpValidator
	{
		...
		/// <param name="OtpEndpoint">OTP Endpoint</param>
		/// <param name="Auditor">Login auditor.</param>
		public HotpValidator(int NrDigits, byte[] Secret, string OtpEndpoint, LoginAuditor Auditor)
		...
		public static Task<HotpValidator> TryCreate(string OtpEndpoint, LoginAuditor Auditor)
		{
			...
			LoginAuditor Auditor)
		{
			...
			return new HotpValidator(NrDigits, Secret.Secret, Secret.HashFunction, OtpEndpoint, Auditor);
		}
		...
		public Task<ValidationResult> Validate(string OtpEndpoint, string RemoteEndPoint, long Counter, int PassCode)
		{
