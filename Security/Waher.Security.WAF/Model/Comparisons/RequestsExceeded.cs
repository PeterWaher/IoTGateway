...
namespace Waher.Security.WAF.Model.Comparisons
{
	...
	public class RequestsExceeded : RateLimitComparison
	{
		...
		public RequestsExceeded(XmlElement Xml, WafAction Parent, WebApplicationFirewall Document)
		...
		public override WafAction Create(XmlElement Xml, WafAction Parent, WebApplicationFirewall Document) => new RequestsExceeded(Xml, Parent, Document);
		...
		{
			return this.ReviewIncrement(State, 1);
		}
	}
}
