...
namespace Waher.Security.WAF.Model.Conditions
{
	...
	public class ContentTypeMatch : WafCondition
	{
		...
		public ContentTypeMatch(XmlElement Xml, WafAction Parent, WebApplicationFirewall Document)
		...
		public override WafAction Create(XmlElement Xml, WafAction Parent, WebApplicationFirewall Document) => new ContentTypeMatch(Xml, Parent, Document);
		...
		{
			return this.Review(State, State.Request.Header.ContentType?.Value);
		}
	}
}
