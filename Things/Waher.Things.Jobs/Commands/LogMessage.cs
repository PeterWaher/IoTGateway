...
namespace Waher.Things.Jobs.Commands
{
	...
	public class LogMessage : ICommand
	{
		...
		public LogMessage(JobNode Node)
		{
			this.node = Node;
		}
		...
		{
			return Language.GetStringAsync(typeof(JobSource), 15, "Log message...");
		}
		...
		{
			return Language.GetStringAsync(typeof(JobSource), 16, "Message successfully logged.");
		}
		...
		{
			return Language.GetStringAsync(typeof(JobSource), 17, "Unable to log message.");
		}
