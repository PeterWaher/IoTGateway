...
namespace Waher.Things.Script.Parameters
{
    ...
    public class ScriptDoubleParameterNode : ScriptParameterNode
    {
        ...
        /// Represents a double-precision floating-point-valued script parameter.
        /// </summary>
        public ScriptDoubleParameterNode()
            : base()
        {
        }
        ...
        {
            return Language.GetStringAsync(typeof(ScriptNode), 59, "Double-precision floating-point parameter");
        }
            ...
            SetEditableFormResult Result)
        {
            ...
            else
            {
                ...
                if (CommonTypes.TryParse(s, out double Parsed))
