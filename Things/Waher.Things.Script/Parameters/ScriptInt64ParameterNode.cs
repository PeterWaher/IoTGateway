...
{
    /// <summary>
    /// Represents a 64-bit integer-valued script parameter.
    /// </summary>
    public class ScriptInt64ParameterNode : ScriptParameterNode
    {
        /// <summary>
        /// Represents a 64-bit integer-valued script parameter.
        /// </summary>
        public ScriptInt64ParameterNode()
            : base()
        {
        }
        ...
        {
            return Language.GetStringAsync(typeof(ScriptNode), 50, "64-bit integer-valued parameter");
        }
        ...
        public override Task PopulateForm(DataForm Parameters, Language Language, object Value)
        {
            ...
            TextSingleField Field = new TextSingleField(Parameters, this.ParameterName, this.Label, this.Required,
                new string[] { this.DefaultValue?.ToString() ?? string.Empty }, null, this.Description, LongDataType.Instance,
