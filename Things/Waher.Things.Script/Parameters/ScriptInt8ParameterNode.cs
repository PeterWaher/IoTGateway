...
namespace Waher.Things.Script.Parameters
{
    ...
    /// </summary>
    public class ScriptInt8ParameterNode : ScriptParameterNode
    {
        /// <summary>
        /// Represents a 8-bit integer-valued script parameter.
        /// </summary>
        ...
        public override Task PopulateForm(DataForm Parameters, Language Language, object Value)
        {
            ...
            TextSingleField Field = new TextSingleField(Parameters, this.ParameterName, this.Label, this.Required,
                new string[] { this.DefaultValue?.ToString() ?? string.Empty }, null, this.Description, ByteDataType.Instance,
            ...
            SetEditableFormResult Result)
        {
            ...
            else
            {
                ...
                if (sbyte.TryParse(s, out sbyte Parsed))
