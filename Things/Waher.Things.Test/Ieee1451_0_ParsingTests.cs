...
namespace Waher.Things.Test
{
	...
	public class Ieee1451_0_ParsingTests
	{
		...
		public async Task Test_01_ParseMessage(string Base64Encoded)
		{
			byte[] Bin = Convert.FromBase64String(Base64Encoded);
			Console.Out.WriteLine("Length: " + Bin.Length.ToString());

			Message Message;
			Assert.IsNotNull(Message = await Ieee1451Parser.TryParseMessage(Bin));
		...
		public async Task Test_02_ParseMetaTEDSRequest(bool Base64, bool IncludesMqttPackage, string Encoded)
		{
		...
		public async Task Test_03_ParseMetaTEDSResponse(bool Base64, string Encoded)
		{
			byte[] Bin = Base64 ? Convert.FromBase64String(Encoded) : Hashes.StringToBinary(Encoded);
			Console.Out.WriteLine("Length: " + Bin.Length.ToString());
		...
		public async Task Test_04_ParseTransducerChannelTEDSRequest(bool Base64, bool IncludesMqttPackage, string Encoded)
		{
			byte[] Bin = Base64 ? Convert.FromBase64String(Encoded) : Hashes.StringToBinary(Encoded);
			if (IncludesMqttPackage)
				ProcessMqttPackage(ref Bin);
		...
		[DataRow(true, true, "QAIAMjKCAQAoXzE0NTEuMS42L0QwL0lOVEVST1AtSUVDT04yMDI0L0ZST00tWE1QUABzAwICAFEAAL+35yVzZry21AmfKvZ7HgnO/YQQqARL6LLvECg4K02gteD1Ns5eSwWnco7D22VvRwABAAAAAAAAABUDBWP/AwIBDAoAgICAgICAgoCA+eI=")]
		public async Task Test_05_ParseTransducerChannelTEDSResponse(bool Base64, bool IncludesMqttPackage, string Encoded)
		{
			byte[] Bin = Base64 ? Convert.FromBase64String(Encoded) : Hashes.StringToBinary(Encoded);
			if (IncludesMqttPackage)
				ProcessMqttPackage(ref Bin);
		...
		public async Task Test_06_ParseTransducerNameTEDSRequest(bool Base64, string Encoded)
		{
			byte[] Bin = Base64 ? Convert.FromBase64String(Encoded) : Hashes.StringToBinary(Encoded);
			Console.Out.WriteLine("Length: " + Bin.Length.ToString());
		...
		public async Task Test_07_ParseTransducerNameTEDSResponse(bool Base64, string Encoded)
		{
			byte[] Bin = Base64 ? Convert.FromBase64String(Encoded) : Hashes.StringToBinary(Encoded);
			Console.Out.WriteLine("Length: " + Bin.Length.ToString());
		...
		public async Task Test_08_ParseTransducerSampleDataRequest(bool Base64, bool IncludesMqttPackage, string Encoded)
		{
			byte[] Bin = Base64 ? Convert.FromBase64String(Encoded) : Hashes.StringToBinary(Encoded);
			if (IncludesMqttPackage)
				ProcessMqttPackage(ref Bin);
		...
		public async Task Test_09_ParseTransducerSampleDataResponse(bool Base64, bool IncludesMqttPackage, string Encoded)
		{
			byte[] Bin = Base64 ? Convert.FromBase64String(Encoded) : Hashes.StringToBinary(Encoded);
			if (IncludesMqttPackage)
				ProcessMqttPackage(ref Bin);
		...
		public async Task Test_10_ParseDiscoverNcapRequest(bool Base64, bool IncludesMqttPackage, string Encoded)
		{
			byte[] Bin = Base64 ? Convert.FromBase64String(Encoded) : Hashes.StringToBinary(Encoded);
			if (IncludesMqttPackage)
				ProcessMqttPackage(ref Bin);
		...
		public async Task Test_11_ParseDiscoverNcapResponse(bool Base64, bool IncludesMqttPackage, string Encoded)
		{
			byte[] Bin = Base64 ? Convert.FromBase64String(Encoded) : Hashes.StringToBinary(Encoded);
			if (IncludesMqttPackage)
				ProcessMqttPackage(ref Bin);
		...
		public async Task Test_12_ParseDiscoverTimRequest(bool Base64, bool IncludesMqttPackage, string Encoded)
		{
			byte[] Bin = Base64 ? Convert.FromBase64String(Encoded) : Hashes.StringToBinary(Encoded);
			if (IncludesMqttPackage)
				ProcessMqttPackage(ref Bin);
		...
		public async Task Test_13_ParseDiscoverTimResponse(bool Base64, bool IncludesMqttPackage, string Encoded)
		{
			byte[] Bin = Base64 ? Convert.FromBase64String(Encoded) : Hashes.StringToBinary(Encoded);
			if (IncludesMqttPackage)
				ProcessMqttPackage(ref Bin);
		...
		public async Task Test_14_ParseDiscoverChannelRequest(bool Base64, bool IncludesMqttPackage, string Encoded)
		{
			byte[] Bin = Base64 ? Convert.FromBase64String(Encoded) : Hashes.StringToBinary(Encoded);
			if (IncludesMqttPackage)
				ProcessMqttPackage(ref Bin);
		...
		public async Task Test_15_ParseDiscoverChannelResponse(bool Base64, bool IncludesMqttPackage, string Encoded)
		{
			byte[] Bin = Base64 ? Convert.FromBase64String(Encoded) : Hashes.StringToBinary(Encoded);
			if (IncludesMqttPackage)
				ProcessMqttPackage(ref Bin);
		...
		public async Task Test_16_ParseTransducerSampleDataResponseWithTeds(bool Base64, bool IncludesMqttPackage, 
			string TedsEncoded, string DataEncoded)
		{
			...
			Message = await Ieee1451Parser.TryParseMessage(Bin);
