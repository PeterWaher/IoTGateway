...
{
	/// <summary>
	/// Adds a Boolean-valued meta-data tag on a virtual node.
	/// </summary>
	internal class AddMetaDataBoolean : ICommand
	{
		...
		public AddMetaDataBoolean(VirtualNode Node)
		{
			this.node = Node;
		}
		...
		/// ID of command.
		/// </summary>
		public string CommandID => nameof(AddMetaDataBoolean);
		...
		/// </summary>
		public string SortKey => nameof(AddMetaDataBoolean);
		...
		{
			return new AddMetaDataBoolean(this.node);
		}
		...
		{
			return Language.GetStringAsync(typeof(VirtualNode), 14, "Add Boolean parameter...");
		}
