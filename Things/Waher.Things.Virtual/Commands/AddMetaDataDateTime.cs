...
{
	/// <summary>
	/// Adds a DateTime-valued meta-data tag on a virtual node.
	/// </summary>
	internal class AddMetaDataDateTime : ICommand
	{
		...
		public AddMetaDataDateTime(VirtualNode Node)
		{
			this.node = Node;
		}
		...
		[Required]
		public DateTime TagValue { get; set; }

		/// <summary>
		/// ID of command.
		/// </summary>
		public string CommandID => nameof(AddMetaDataDateTime);
		...
		{
			return new AddMetaDataDateTime(this.node);
		}
		...
		{
			return Language.GetStringAsync(typeof(VirtualNode), 15, "Add Date & Time parameter...");
		}
