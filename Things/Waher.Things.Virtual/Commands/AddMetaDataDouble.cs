...
{
	/// <summary>
	/// Adds a floating-point-valued meta-data tag on a virtual node.
	/// </summary>
	internal class AddMetaDataDouble : ICommand
	{
		...
		public AddMetaDataDouble(VirtualNode Node)
		{
			this.node = Node;
		}
		...
		/// ID of command.
		/// </summary>
		public string CommandID => nameof(AddMetaDataDouble);
		...
		/// </summary>
		public string SortKey => nameof(AddMetaDataDouble);
		...
		{
			return new AddMetaDataDouble(this.node);
		}
		...
		{
			return Language.GetStringAsync(typeof(VirtualNode), 13, "Add floating-point parameter...");
		}
