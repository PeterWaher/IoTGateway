...
namespace Waher.Things.Virtual.Commands
{
	...
	/// </summary>
	internal class AddMetaDataInt32 : ICommand
	{
		...
		/// ID of command.
		/// </summary>
		public string CommandID => nameof(AddMetaDataInt32);
		...
		/// </summary>
		public string SortKey => nameof(AddMetaDataInt32);
		...
		{
			return new AddMetaDataInt32(this.node);
		}
		...
		{
			return Language.GetStringAsync(typeof(VirtualNode), 11, "Add 32-bit integer parameter...");
		}
