...
{
	/// <summary>
	/// Adds a 64-bit integer-valued meta-data tag on a virtual node.
	/// </summary>
	internal class AddMetaDataInt64 : ICommand
	{
		...
		public AddMetaDataInt64(VirtualNode Node)
		{
			this.node = Node;
		}
		...
		/// ID of command.
		/// </summary>
		public string CommandID => nameof(AddMetaDataInt64);
		...
		{
			return new AddMetaDataInt64(this.node);
		}
		...
		{
			return Language.GetStringAsync(typeof(VirtualNode), 12, "Add 64-bit integer parameter...");
		}
