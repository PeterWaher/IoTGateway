...
namespace Waher.Things.Virtual.Commands
{
	...
	/// </summary>
	internal class AddMetaDataString : ICommand
	{
		...
		/// ID of command.
		/// </summary>
		public string CommandID => nameof(AddMetaDataString);
		...
		/// </summary>
		public string SortKey => nameof(AddMetaDataString);
		...
		{
			return new AddMetaDataString(this.node);
		}
		...
		{
			return Language.GetStringAsync(typeof(VirtualNode), 8, "Add string parameter...");
		}
