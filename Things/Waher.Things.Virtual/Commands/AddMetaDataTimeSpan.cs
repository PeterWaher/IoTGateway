...
{
	/// <summary>
	/// Adds a TimeSpan-valued meta-data tag on a virtual node.
	/// </summary>
	internal class AddMetaDataTimeSpan : ICommand
	{
		...
		public AddMetaDataTimeSpan(VirtualNode Node)
		{
			this.node = Node;
		}
		...
		[Required]
		public TimeSpan TagValue { get; set; }

		/// <summary>
		/// ID of command.
		/// </summary>
		public string CommandID => nameof(AddMetaDataTimeSpan);
		...
		/// </summary>
		public string SortKey => nameof(AddMetaDataTimeSpan);
		...
		{
			return new AddMetaDataTimeSpan(this.node);
		}
		...
		{
			return Language.GetStringAsync(typeof(VirtualNode), 16, "Add Time-span parameter...");
		}
