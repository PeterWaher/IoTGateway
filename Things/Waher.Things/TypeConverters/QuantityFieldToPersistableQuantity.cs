...
{
	/// <summary>
	/// Converts a <see cref="QuantityField"/> to a <see cref="PersistableQuantity"/>.
	/// </summary>
	public class QuantityFieldToPersistableQuantity : ITypeConverter
	{
		/// <summary>
		/// Converts a <see cref="QuantityField"/> to a <see cref="PersistableQuantity"/>.
		/// </summary>
		public QuantityFieldToPersistableQuantity()
		{
		}
		...
		public object Convert(object Value)
		{
			if (Value is QuantityField Field)
				return Field.PersistableQuantity;
			else
		...
		{
			if (Value is QuantityField Field)
				return new ObjectValue(Field.PersistableQuantity);
			else
				throw new ArgumentException("Not a QuantityField.", nameof(Value));
		}
	}
