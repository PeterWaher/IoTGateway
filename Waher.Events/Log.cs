	...
	public static class Log
	{
		...
		public static void Event(Event Event)
		{
			lock (queue)
			{
				...
				if (thread == null)
				{
					thread = new Thread(DistributionThread);
					thread.Name = "Event Log distribution thread";
		...
		private static void DistributionThread()
		{
			WaitHandle[] Handles = new WaitHandle[] { queued, terminated };
