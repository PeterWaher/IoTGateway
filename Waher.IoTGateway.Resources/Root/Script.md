...
| `EnableFts(Index,Collection)`                                                    | Matches a Full-Text-Search Index, defined by `Index`, with a Database Collection, defined by `Collection`. | `EnableFts("FTS","Default")` |
...
| `Xml(s)`                         | Converts the string `s` to an XML Document. If `s` is null, `null` is returned.                                                                                                                            | `Xml("<a>Hello</a>")`                      |
