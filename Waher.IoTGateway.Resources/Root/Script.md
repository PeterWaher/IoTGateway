...
| `ColorsGradient(colors,p)` | Returns a color from a color gradient defined by a vector of colors and an interpolation constant 0<=`p`<=1.                                                            | `ColorGradient(["Green","Yellow","Red"],0.75)` |
