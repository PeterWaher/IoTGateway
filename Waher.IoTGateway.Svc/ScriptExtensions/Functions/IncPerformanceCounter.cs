...
namespace Waher.IoTGateway.Svc.ScriptExtensions.Functions
{
    ...
    public class IncPerformanceCounter : FunctionMultiVariate
	{
        ...
        /// <param name="Length">Length of expression covered by node.</param>
        /// <param name="Expression">Expression containing script.</param>
        public IncPerformanceCounter(ScriptNode Category, ScriptNode InstanceName, ScriptNode CounterName, int Start, int Length, Expression Expression)
        ...
        /// </summary>
        public override string FunctionName => nameof(IncPerformanceCounter);
