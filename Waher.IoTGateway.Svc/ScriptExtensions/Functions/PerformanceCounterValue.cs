...
namespace Waher.IoTGateway.Svc.ScriptExtensions.Functions
{
    ...
    /// </summary>
    public class PerformanceCounterValue : FunctionMultiVariate
	{
        /// <summary>
        /// Returns a performance counter value, given a performance category name, optional instance name, as well as a counter name.
        /// </summary>
        ...
        public PerformanceCounterValue(ScriptNode Category, ScriptNode CounterName, int Start, int Length, Expression Expression)
