...
namespace Waher.IoTGateway
{
	...
	public static class Gateway
	{
		...
		/// 
		/// Note: Use this method, rather than calling <see cref="Gateway.ContractsClient"/> directly, to avoid throwing an
		/// <see cref="UnauthorizedAccessException"/>. The method is restricted and can only be called from a given set of sources.
		/// </summary>
		...
		{
			LegalIdentityConfiguration.CreateContract(ForMachines, ForHumans, Roles, Parts, Parameters, Visibility, PartsMode, Duration,
		...
		public static void CreateContract(string Address, XmlElement ForMachines, HumanReadableText[] ForHumans, Role[] Roles,
			...
			SmartContractEventHandler Callback, object State)
		{
			LegalIdentityConfiguration.CreateContract(Address, ForMachines, ForHumans, Roles, Parts, Parameters, Visibility, PartsMode, Duration,
				ArchiveRequired, ArchiveOptional, SignAfter, SignBefore, CanActAsTemplate, Callback, State);
		}
		...
		public static Task<Contract> CreateContractAsync(XmlElement ForMachines, HumanReadableText[] ForHumans, Role[] Roles,
			...
			Duration ArchiveRequired, Duration ArchiveOptional, DateTime? SignAfter, DateTime? SignBefore, bool CanActAsTemplate)
		{
			return LegalIdentityConfiguration.CreateContractAsync(ForMachines, ForHumans, Roles, Parts, Parameters, Visibility, PartsMode, Duration,
		...
		public static Task<Contract> CreateContractAsync(string Address, XmlElement ForMachines, HumanReadableText[] ForHumans, Role[] Roles,
			...
			Duration ArchiveRequired, Duration ArchiveOptional, DateTime? SignAfter, DateTime? SignBefore, bool CanActAsTemplate)
		{
			return LegalIdentityConfiguration.CreateContractAsync(Address, ForMachines, ForHumans, Roles, Parts, Parameters, Visibility, PartsMode,
		...
		{
			LegalIdentityConfiguration.CreateContract(TemplateId, Parts, Parameters, Visibility, PartsMode, Duration, ArchiveRequired, ArchiveOptional,
		...
		public static void CreateContract(string Address, string TemplateId, Part[] Parts, Parameter[] Parameters, ContractVisibility Visibility,
			...
			DateTime? SignBefore, bool CanActAsTemplate, SmartContractEventHandler Callback, object State)
		{
			LegalIdentityConfiguration.CreateContract(Address, TemplateId, Parts, Parameters, Visibility, PartsMode, Duration,
				ArchiveRequired, ArchiveOptional, SignAfter, SignBefore, CanActAsTemplate, Callback, State);
		}
		...
		{
			return LegalIdentityConfiguration.CreateContractAsync(TemplateId, Parts, Parameters, Visibility, PartsMode, Duration,
				ArchiveRequired, ArchiveOptional, SignAfter, SignBefore, CanActAsTemplate);
		}
		...
		{
			return LegalIdentityConfiguration.CreateContractAsync(Address, TemplateId, Parts, Parameters, Visibility, PartsMode, Duration,
				ArchiveRequired, ArchiveOptional, SignAfter, SignBefore, CanActAsTemplate);
		}
