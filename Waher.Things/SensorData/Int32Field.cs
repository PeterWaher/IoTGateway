...
namespace Waher.Things.SensorData
{
	...
	public class Int32Field : Field
	{
		...
		/// <param name="Module">Language Module for localization purposes.</param>
		/// <param name="StringIdSteps">String ID steps.</param>
		public Int32Field(ThingReference Thing, DateTime Timestamp, string Name, int Value, FieldType Type, FieldQoS QoS, bool Writable, string Module, params int[] StringIds)
		...
		/// <param name="Module">Language Module for localization purposes.</param>
		/// <param name="StringIdSteps">String ID steps.</param>
		public Int32Field(ThingReference Thing, DateTime Timestamp, string Name, int Value, FieldType Type, FieldQoS QoS, string Module, params int[] StringIds)
