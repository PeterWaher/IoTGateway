...
namespace Waher.Things.SensorData
{
	...
	public class StringField : Field
	{
		...
		/// <param name="Module">Language Module for localization purposes.</param>
		/// <param name="StringIdSteps">String ID steps.</param>
		public StringField(ThingReference Thing, DateTime Timestamp, string Name, string Value, FieldType Type, FieldQoS QoS, bool Writable, string Module, params int[] StringIds)
		...
		/// <param name="Module">Language Module for localization purposes.</param>
		/// <param name="StringIdSteps">String ID steps.</param>
		public StringField(ThingReference Thing, DateTime Timestamp, string Name, string Value, FieldType Type, FieldQoS QoS, string Module, params int[] StringIds)
